...
--
-- Host: localhost:3306
-- Generation Time: May 15, 2025 at 03:48 PM
...
--
-- Database: `spurtv5_no_data_community`
--
...
(57, 'Product Cancellation by Buyer', 'Order Cancellation Request from Buyer', 'Dear {sellerName},<br/><br/>\n                <p style=\"margin-bottom:.5em; margin: 0 0 10px 0; text-indent: 50px\">The buyer has requested to cancel the ordered product: <strong>{productName}</strong>. Please review and respond to the cancellation request.</p>', NULL, '2025-05-15 15:47:54', '2025-05-15 15:47:54', NULL, NULL, '{sellerName},{productName}');
...
(724, 1732273657099, 'UpdateRowCustomerWordToBuyerInPermmisionModules1732273657099'),
(725, 1732521508422, 'AddSellerGroupPermissionModule1732521508422'),
(726, 1732621428711, 'AddAddonSettingPermission1732621428711'),
(727, 1732687090046, 'UpdateVendorToSellerNamePermission1732687090046'),
(728, 1732687359333, 'RemoveDocumentPermissionModule1732687359333'),
(729, 1732863438138, 'RemoveMarketplacePermission1732863438138'),
(730, 1733402679634, 'AddForeignKeyToPermissionModule1733402679634'),
(731, 1733402809834, 'RemoveUnwantedPermissionModule1733402809834'),
(732, 1733553848401, 'AddIndustryIdToCategory1733553848401'),
(733, 1733808519425, 'SetIndustryIdToNull1733808519425'),
(734, 1733893642906, 'UpdateForeignKeyToZero1733893642906'),
(735, 1734505243936, 'AddPermissionModuleGroupMarketPlaceProduct1734505243936'),
(736, 1734594742783, 'AddPermissionModuleGroupSeller1734594742783'),
(737, 1734676241366, 'AddColumnTimeZoneInSettings1734676241366'),
(738, 1734692907834, 'RemoveUnusedPermissionModule1734692907834'),
(739, 1735801417071, 'RemoveDuplicateRecordsInVedorGroupCategory1735801417071'),
(740, 1736404694182, 'ExportLogTableAddColumn1736404694182'),
(741, 1737091346152, 'CreateProductRatingImagesTable1737091346152'),
(742, 1737171769521, 'AddPermissionModuleGroupSeller1737171769521'),
(743, 1737719913797, 'AddVarientInPermissionModule1737719913797'),
(744, 1738299112649, 'AddEmailTemplateForVendorNotifyProduct1738299112649'),
(745, 1743163860003, 'AddCollumnsSettingsTable1743163860003'),
(746, 1743426704992, 'AddColumnProductTable1743426704992'),
(747, 1743501439629, 'CreateTableOrderProductCancelLogTable1743501439629'),
(748, 1744017287521, 'CreateOrderCancellationEmailTemplate1744017287521'),
(749, 1744979289113, 'AddCopyRightsColumnInSettings1744979289113'),
(750, 1746270416041, 'UpdateEmailTemplate1746270416041'),
(751, 1746690271994, 'UpdateEmailTemplateSellerApproval1746690271994'),
(752, 1747114024567, 'UpdateCODLogo1747114024567');
...
--
-- Table structure for table `order_product_cancel_log`
--
...
(174, 'Buyer Address list', 'buyer-address-list', 230, 77, NULL, '2021-08-04 12:24:56', NULL, '2021-08-04 12:24:56', 0),
...
(184, 'Settlement Report List', 'settlement-report-list', 164, 47, NULL, '2021-03-18 17:19:53', NULL, '2021-03-18 17:19:53', 0),
...
(227, 'Add Variants', 'variant-add', 244, 64, NULL, '2022-06-09 04:52:14', NULL, '2022-06-09 04:52:14', 0),
(231, 'Product Variant List', 'variant-product-list', 251, 64, NULL, '2022-06-09 04:52:14', NULL, '2022-06-09 04:52:14', 0),
...
(239, 'Common Catalog Product List', 'common-catalog-product-list', 259, 69, NULL, '2022-06-09 04:52:14', NULL, '2022-06-09 04:52:14', 0),
(240, 'Set Common Product', 'set-common-product', 260, NULL, NULL, '2022-06-09 04:52:14', NULL, '2022-06-09 04:52:14', 0),
(241, 'Set Common Products', 'set-common-products', 261, 69, NULL, '2022-06-09 04:52:14', NULL, '2022-06-09 04:52:14', 0),
(242, 'Common Product Detail', 'common-product-detail', 262, 69, NULL, '2022-06-09 04:52:14', NULL, '2022-06-09 04:52:14', 0),
(243, 'Edit Common Product Status', 'update-common-product-status', 263, 69, NULL, '2022-06-09 04:52:14', NULL, '2022-06-09 04:52:14', 0),
...
(355, 'Addons', 'edit-addons', 319, 16, NULL, '2025-05-15 15:47:53', NULL, '2025-05-15 15:47:53', 0);
...
(64, 'Variant', 'variants', 69, NULL, '2022-06-09 04:52:14', NULL, '2022-06-09 04:52:14'),
...
(69, 'Common Products', 'common-products', 74, NULL, '2023-12-13 06:58:15', NULL, '2023-12-13 06:58:15'),
...
(1, 'CashOnDelivery', 'cod payment_1747113838765.png', 'logo/', 'Payment', NULL, 1, '2022-11-01 14:54:56', NULL, '2024-10-22 05:31:46', NULL, NULL, 'cash-on-delivery', 0, NULL, NULL, 'Cash On Delivery'),
...
--
-- Table structure for table `product_rating_images`
--
...
CREATE TABLE `settings` (
  ...
  `seller_approval_timeframe_unit` enum('hours','days','weeks') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Indexes for table `order_product_cancel_log`
--
ALTER TABLE `order_product_cancel_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_order_product_cancel_log_order_product_order_product_id` (`order_product_id`);
...
--
-- Indexes for table `product_rating_images`
--
ALTER TABLE `product_rating_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_product_rating_images_product_rating_rating_id` (`rating_id`);
...
--
-- AUTO_INCREMENT for table `order_product_cancel_log`
--
ALTER TABLE `order_product_cancel_log`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `permission_module`
  MODIFY `module_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=356;
...
--
-- AUTO_INCREMENT for table `product_rating_images`
--
ALTER TABLE `product_rating_images`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `order_product_cancel_log`
--
ALTER TABLE `order_product_cancel_log`
  ADD CONSTRAINT `fk_order_product_cancel_log_order_product_order_product_id` FOREIGN KEY (`order_product_id`) REFERENCES `order_product` (`order_product_id`) ON DELETE RESTRICT;
...
--
-- Constraints for table `product_rating_images`
--
ALTER TABLE `product_rating_images`
  ADD CONSTRAINT `fk_product_rating_images_product_rating_rating_id` FOREIGN KEY (`rating_id`) REFERENCES `product_rating` (`rating_id`) ON DELETE CASCADE;
