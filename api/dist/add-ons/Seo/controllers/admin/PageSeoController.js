...
let SeoPageController = class SeoPageController {
    ...
    updateSeo(pageId, seo, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const page = yield this.pageService.findOne({ where: { pageId } });
            if (!page) {
                const errorResponse = {
                    status: 0,
...
tslib_1.__decorate([
    ...
    (0, routing_controllers_1.Authorized)(['admin', 'pages-seo']),
...
exports.SeoPageController = SeoPageController = tslib_1.__decorate([
