...
let SeoCategoryController = class SeoCategoryController {
    ...
    updateSeo(categoryId, seo, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const category = yield this.categoryService.findOne({ where: { categoryId } });
            if (!category) {
                const errorResponse = {
                    status: 0,
...
tslib_1.__decorate([
    ...
    (0, routing_controllers_1.Authorized)(['admin', 'category-seo']),
...
exports.SeoCategoryController = SeoCategoryController = tslib_1.__decorate([
