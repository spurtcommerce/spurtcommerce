...
let SiteMapController = class SiteMapController {
    ...
    createSiteMap(request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const productDefaultUrl = env_1.env.storeRedirectUrl + '/products/';
            findProduct.map((val) => {
                if (val.productSlug) {
            ...
            const categoryDefaultUrl = env_1.env.storeRedirectUrl + '/product/';
            ...
            const findPages = yield this.pageService.findAll({ select: ['slugName'], where: { isActive: 1 } });
...
tslib_1.__decorate([
    ...
    (0, routing_controllers_1.Authorized)(['admin', 'site-map-seo']),
...
exports.SiteMapController = SiteMapController = tslib_1.__decorate([
