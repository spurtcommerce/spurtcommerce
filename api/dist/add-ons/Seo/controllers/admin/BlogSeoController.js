...
let SeoBlogController = class SeoBlogController {
    ...
    updateSeo(blogId, seo, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const Blog = yield this.blogService.findOne({ where: { blogId } });
            if (!Blog) {
                const errorResponse = {
                    status: 0,
...
tslib_1.__decorate([
    ...
    (0, routing_controllers_1.Authorized)(['admin', 'blog-seo']),
...
exports.SeoBlogController = SeoBlogController = tslib_1.__decorate([
