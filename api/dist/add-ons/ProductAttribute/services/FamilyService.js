...
let FamilyService = class FamilyService {
    constructor(familyRepository, log) {
    ...
    create(ticket) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.log.info('Create a new ticket ');
            return this.familyRepository.repository.save(ticket);
        });
    }
    // find Condition
    find(ticket) {
        return this.familyRepository.repository.find(ticket);
    }
    // find one Condition
    findOne(ticket) {
        return this.familyRepository.repository.findOne(ticket);
    }
    // update ticket
    update(ticket) {
        return this.familyRepository.repository.save(ticket);
    ...
    list(limit, offset, select = [], relations = [], search = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.familyRepository.repository.count(condition);
        }
        else {
            return this.familyRepository.repository.find(condition);
        }
    }
    // listByQueryBuilder
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(Family_1.Family).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.familyRepository.repository.delete(id);
        });
    }
};
exports.FamilyService = FamilyService;
exports.FamilyService = FamilyService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
    tslib_1.__param(1, (0, Logger_1.Logger)(__filename)),
    tslib_1.__metadata("design:paramtypes", [FamilyRepository_1.FamilyRepository, Object])
], FamilyService);
