...
let AttributeService = class AttributeService {
    ...
    create(attribute) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.attributeRepository.repository.save(attribute);
        });
    }
    // findOne
    findOne(data) {
        return this.attributeRepository.repository.findOne(data);
    }
    // update
    update(id, attribute) {
        attribute.id = id;
    ...
    list(limit, offset, select = [], search = [], relation = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.attributeRepository.repository.count(condition);
        }
        else {
            return this.attributeRepository.repository.find(condition);
        }
    }
    // delete
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.attributeRepository.repository.delete(id);
        });
    }
    softDelete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.attributeRepository.repository.update(id, { isDelete: 1 });
        });
    }
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(Attribute_1.Attribute).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
    ...
    // find All
    find(data) {
        return this.attributeRepository.repository.find(data);
    }
};
exports.AttributeService = AttributeService;
exports.AttributeService = AttributeService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
