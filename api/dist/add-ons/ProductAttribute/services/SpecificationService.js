...
let SpecificationService = class SpecificationService {
    ...
    create(specification) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.specificationRepository.repository.save(specification);
        });
    }
    // findOne
    findOne(condition) {
        return this.specificationRepository.repository.findOne(condition);
    }
    // findOne
    find(condition) {
        return this.specificationRepository.repository.find(condition);
    }
    delete(condition) {
        return this.specificationRepository.repository.delete(condition);
    }
    softDelete(condition) {
        return this.specificationRepository.repository.update(condition, { isDelete: 1 });
    }
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(Specification_1.Specification).createQueryBuilder();
            // Select
...
exports.SpecificationService = SpecificationService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
