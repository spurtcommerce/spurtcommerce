...
let AttributeGroupService = class AttributeGroupService {
    ...
    create(attribute) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.attributeGroupRepository.repository.save(attribute);
        });
    }
    // findOne
    findOne(data) {
        return this.attributeGroupRepository.repository.findOne(data);
    }
    // update
    update(id, attributeGroup) {
        attributeGroup.id = id;
        return this.attributeGroupRepository.repository.save(attributeGroup);
    }
    // address
    list(limit, offset, select = [], search = [], relation = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.attributeGroupRepository.repository.count(condition);
        }
        else {
            return this.attributeGroupRepository.repository.find(condition);
        }
    }
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(AttributeGroup_1.AttributeGroup).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.attributeGroupRepository.repository.delete(id);
        });
    }
    softDelete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.attributeGroupRepository.repository.update(id, { isDelete: 1 });
        });
    }
    // find All
    find(address) {
        return this.attributeGroupRepository.repository.find(address);
    }
};
exports.AttributeGroupService = AttributeGroupService;
exports.AttributeGroupService = AttributeGroupService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
