...
const DeleteSpecificationRequest_1 = require("./requests/DeleteSpecificationRequest");
const typeormLoader_1 = require("../../../../src/loaders/typeormLoader");
const typedi_1 = require("typedi");
let VendorProductSpecificationController = class VendorProductSpecificationController {
    constructor(productToSpecService, productService, vendorProductService, productToCategoryService, categoryService, categoryPathService, specificationToCategoryService) {
    ...
    /**
     * @api {get} /api/vendor-product-specification/product/:id Get product Specification Detail API
     * @apiGroup VendorProductSpecification
     ...
     *    }
     * }
     * @apiSampleRequest /api/vendor-product-specification/product/:id
    ...
    /**
     * @api {Get} /api/vendor-product-specification/products Get All Product Attribute list API
     * @apiGroup VendorProductSpecification
     * @apiHeader {String} Authorization
     ...
     *    ]
     * }
     * @apiSampleRequest /api/vendor-product-specification/products
     * @apiErrorExample {json} product specification error
     * HTTP/1.1 500 Internal Server Error
     */
    ...
    /**
     * @api {Post} api/vendor-product-specification create product Specification API
     * @apiGroup VendorProductSpecification
     * @apiHeader {String} Authorization
     * @apiParam (Request body) {Number} productId productId
     ...
     * }
     * @apiSampleRequest api/vendor-product-specification
     * @apiErrorExample {json} product specification error
     * HTTP/1.1 500 Internal Server Error
     */
    ...
    /**
     * @api {Put} api/vendor-product-specification/attribute-slug/product/:id Update product Specification Slug API
     * @apiGroup VendorProductSpecification
     * @apiHeader {String} Authorization
     ...
     *    }
     * }
     * @apiSampleRequest api/vendor-product-specification/attribute-slug/product/:id
     * @apiErrorExample {json} product specification error
     * HTTP/1.1 500 Internal Server Error
     */
    ...
    /**
     * @api {Put} /api/vendor-product-specification/product/:id Update Product Specification API
     * @apiGroup VendorProductSpecification
     * @apiHeader {String} Authorization
     * @apiParam (Request body) {Number} productId productId
    ...
    // Delete Specification Based on category API
    /**
     * @api {Delete} /api/vendor-product-specification/product/:id Delete Specification Based on category API
     * @apiGroup VendorProductSpecification
     * @apiHeader {String} Authorization
     * @apiParam (Request body) {String} categoryIds categoryIds
     * @apiParamExample {json} Input
     * {
     *    "categoryIds": "",
     * }
     ...
     * {
     *    "status": 1,
     *    "message": "Categories related specifications deleted successfully."
     * }
     * @apiSampleRequest /api/vendor-product-specification/product/:id
     * @apiErrorExample {json} product specification error
     * HTTP/1.1 500 Internal Server Error
     */
    deleteSpecification(productId, payload, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const vendorProduct = yield this.vendorProductService.findOne({
                where: {
                    productId,
            ...
            const specToCategory = yield this.specificationToCategoryService.find({
                where: {
                    categoryId: (0, typeorm_1.In)(payload.categoryIds.split(',')),
                },
            });
            const specificationIds = [
                ...new Set(specToCategory.map((val) => val.specificationId)),
            ];
            yield this.productToSpecService.delete({
                specificationId: (0, typeorm_1.In)(specificationIds),
                productId,
            });
            return response.status(200).send({
                status: 1,
...
tslib_1.__decorate([
    (0, routing_controllers_1.Delete)('/product/:id'),
    (0, routing_controllers_1.Authorized)('vendor'),
    tslib_1.__param(0, (0, routing_controllers_1.Param)('id')),
    tslib_1.__param(1, (0, routing_controllers_1.Body)({ validate: true })),
    tslib_1.__param(2, (0, routing_controllers_1.Res)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, DeleteSpecificationRequest_1.DeleteSpecificationRequest, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], VendorProductSpecificationController.prototype, "deleteSpecification", null);
exports.VendorProductSpecificationController = VendorProductSpecificationController = tslib_1.__decorate([
