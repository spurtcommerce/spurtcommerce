...
let RelatedProductController = class RelatedProductController {
    constructor(productService, productRelatedService, productToCategoryService, categoryService, productTranslationService) {
    ...
    relatedProductList(productid, count, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const promises = relatedData.map((results) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                var _a, _b, _c;
                const temp = results;
                const productTranslation = yield this.productTranslationService.findOne({ where: { productId: results.productId, languageId: (_a = request.languageId) !== null && _a !== void 0 ? _a : 0 } });
...
exports.RelatedProductController = RelatedProductController = tslib_1.__decorate([
