...
let ProductRelatedController = class ProductRelatedController {
    ...
    productRelatedDetail(productId, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const productDetails = yield this.productService.findOne({
                select: ['productId', 'description', 'sku', 'name', 'productSlug', 'createdDate', 'modifiedDate'],
                where: {
                    productId,
                },
            });
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    productList(limit, offset, keyword, productName, sku, count, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const select = [
...
exports.ProductRelatedController = ProductRelatedController = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [ProductService_1.ProductService,
        ...
        SkuService_1.SkuService, ProductSpecialService_1.ProductSpecialService])
