...
const ProductRelatedRepository_1 = require("../repository/ProductRelatedRepository");
...
let ProductRelatedService = class ProductRelatedService {
    ...
    create(product) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.productRelatedRepository.repository.save(product);
            return newProduct;
        });
    }
    ...
    findAll(Id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.productRelatedRepository.repository.find(Id);
        });
    }
    // find related product
    find(productRelated) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.log.info('find a related product');
            return yield this.productRelatedRepository.repository.find(productRelated);
        });
    }
    // count related product
    productRelatedCount(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.productRelatedRepository.productRelatedCount(id);
        });
    }
    ...
    list(limit, offset, relation = [], select = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.productRelatedRepository.repository.count(condition);
        }
        return this.productRelatedRepository.repository.find(condition);
    }
    // delete related product
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.log.info('Delete a related product');
            const newProduct = yield this.productRelatedRepository.repository.delete(id);
            return newProduct;
        });
    }
    // find one related product
    findOne(relatedProduct) {
        return this.productRelatedRepository.repository.findOne(relatedProduct);
    }
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(ProductRelated_1.ProductRelated).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
exports.ProductRelatedService = ProductRelatedService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
