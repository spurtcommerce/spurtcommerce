...
class AbandonedCartMailTemplate1689683250355 {
    up(queryRunner) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const ifTemplate = yield (0, typeormLoader_1.getDataSource)().getRepository(EmailTemplate_1.EmailTemplate).findOne({ where: { emailTemplateId: 30 } });
            if (!ifTemplate) {
                yield (0, typeormLoader_1.getDataSource)().getRepository(EmailTemplate_1.EmailTemplate).save(templateSeed);
            }
        });
    }
    down(queryRunner) {
