...
let ProductAnswerLikeService = class ProductAnswerLikeService {
    ...
    create(product) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.productAnswerLikeRepository.repository.save(product);
            return newProduct;
        });
    }
    ...
    findAll(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productAnswerLikeRepository.repository.find(data);
        });
    }
    // find product answer like dislike
    list(limit, offset, select = [], search = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.productAnswerLikeRepository.repository.count(condition);
        }
        else {
            return this.productAnswerLikeRepository.repository.find(condition);
        }
    }
    // delete productAnswerLikeRepository
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.productAnswerLikeRepository.repository.delete(id);
            return newProduct;
        });
    }
    // find one productAnswerLikeRepository
    findOne(data) {
        return this.productAnswerLikeRepository.repository.findOne(data);
    }
    // find like count
...
exports.ProductAnswerLikeService = ProductAnswerLikeService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
