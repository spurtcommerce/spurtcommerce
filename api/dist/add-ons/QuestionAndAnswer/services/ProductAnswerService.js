...
let ProductAnswerService = class ProductAnswerService {
    ...
    create(answer) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.productAnswerRepository.repository.save(answer);
        });
    }
    // findCondition
    findOne(answer) {
        return this.productAnswerRepository.repository.findOne(answer);
    }
    // update country
    update(id, answer) {
        answer.answerId = id;
    ...
    list(limit, offset, select = [], search = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.productAnswerRepository.repository.count(condition);
        }
        else {
            return this.productAnswerRepository.repository.find(condition);
        }
    }
    // delete Country
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productAnswerRepository.repository.delete(id);
        });
    }
    // find a data
    findAll(productDiscount) {
        this.log.info('Find a data');
        return this.productAnswerRepository.repository.find(productDiscount);
    }
};
exports.ProductAnswerService = ProductAnswerService;
exports.ProductAnswerService = ProductAnswerService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
