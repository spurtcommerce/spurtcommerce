...
let AnswerReportAbuseService = class AnswerReportAbuseService {
    ...
    create(answerAbuse) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.answerReportAbuseRepository.repository.save(answerAbuse);
        });
    }
    // findOne
    findOne(answerAbuse) {
        return this.answerReportAbuseRepository.repository.findOne(answerAbuse);
    }
    // update
    ...
    list(limit, offset, select = [], search = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.answerReportAbuseRepository.repository.count(condition);
        }
        else {
            return this.answerReportAbuseRepository.repository.find(condition);
        }
    }
    // delete
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.answerReportAbuseRepository.repository.delete(id);
        });
    }
    // find All
    find(address) {
        return this.answerReportAbuseRepository.repository.find(address);
    }
};
exports.AnswerReportAbuseService = AnswerReportAbuseService;
exports.AnswerReportAbuseService = AnswerReportAbuseService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
