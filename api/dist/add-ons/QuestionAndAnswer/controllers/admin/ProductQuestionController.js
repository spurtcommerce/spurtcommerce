...
let ProductQuestionController = class ProductQuestionController {
    constructor(productQuestionService, customerService, userService, productAnswerService, vendorService, productService, skuService) {
     ...
     * @apiErrorExample {json} updateQuestionStatus error
     * HTTP/1.1 500 Internal Server Error
     */
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    questionproductList(limit, offset, keyword, productName, count, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const select = [
...
exports.ProductQuestionController = ProductQuestionController = tslib_1.__decorate([
