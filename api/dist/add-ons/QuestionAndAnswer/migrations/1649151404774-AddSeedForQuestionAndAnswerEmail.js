    ...
    up(queryRunner) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (exist.length === 0) {
                ...
                yield (0, typeormLoader_1.getDataSource)().getRepository('EmailTemplate').save(QuestionAndAnswerEmailSeed);
            }
            ...
            if (exist1.length === 0) {
                ...
                yield (0, typeormLoader_1.getDataSource)().getRepository('EmailTemplate').save(AnswerEmailSeed);
            }
            ...
            if (exist3.length === 0) {
                ...
                yield (0, typeormLoader_1.getDataSource)().getRepository('EmailTemplate').save(ReportEmailSeed);
            }
        });
    }
    down(queryRunner) {
