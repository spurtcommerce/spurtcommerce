    ...
    up(queryRunner) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (exist.length === 0) {
                ...
                yield (0, typeormLoader_1.getDataSource)().getRepository('AnswerAbuseReason').save(answerAbuseReasonSeed1);
            }
            ...
            if (exist1.length === 0) {
                ...
                yield (0, typeormLoader_1.getDataSource)().getRepository('AnswerAbuseReason').save(answerAbuseReasonSeed2);
            }
            ...
            if (exist2.length === 0) {
                ...
                yield (0, typeormLoader_1.getDataSource)().getRepository('AnswerAbuseReason').save(answerAbuseReasonSeed3);
            }
        });
    }
    down(queryRunner) {
