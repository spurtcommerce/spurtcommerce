...
exports.CustomerTicketController = void 0;
...
let CustomerTicketController = class CustomerTicketController {
    ...
    /**
     * @api {get} /api/customer-support-ticket/ticket-category Get Customer Support Ticket Categories API
     * @apiGroup Customer Support Ticket Category
     * @apiDescription This API retrieves a list of customer support ticket categories based on the provided query parameters.
     *
     ...
     * }
     *
     * @apiSampleRequest /api/customer-support-ticket/ticket-category
     *
     * @apiErrorExample {json} Error Response
     * HTTP/1.1 500 Internal Server Error
     * {
     *   "message": "Failed to retrieve customer support ticket categories",
     *   "status": "0"
     * }
     */
    ...
    // post ticket and message
    /**
     * @api {post} /api/customer-support-ticket Create Customer Support Ticket API
     * @apiGroup Customer Support Ticket
     * @apiDescription This API allows customers to create a support ticket by submitting a category, sub-category, ticket details, message, and optional attachments.
     *
     ...
     * }
     *
     * @apiSampleRequest /api/customer-support-ticket
     *
     * @apiErrorExample {json} Error Response
     * HTTP/1.1 500 Internal Server Error
     * {
    ...
    createTicket(createTicketRequest, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (ticket) {
                ...
                replyMessage.senderId = request.user.id;
                replyMessage.senderType = Tickets_1.UserType.BUYER;
                ...
                if (createTicketRequest.attachments.length !== 0) {
                    for (const attachments of createTicketRequest.attachments) {
                        ...
                        newTicketAttachment.createdByType = Tickets_1.UserType.BUYER;
                        newTicketAttachment.ticketMessageId = ticketMessage.id;
                        ticketMessageAttachments.push(newTicketAttachment);
                    }
                    yield this.ticketAttachmentsService.create(ticketMessageAttachments);
                }
                ...
                ticketLog.actionBy = request.user.id;
                ticketLog.actionByType = Tickets_1.UserType.BUYER;
            ...
            newTickets.userId = request.user.id;
            newTickets.userType = Tickets_1.UserType.BUYER;
            ...
            newTicketMessage.senderId = request.user.id;
            newTicketMessage.senderType = Tickets_1.UserType.BUYER;
            newTicketMessage.ticketId = savedTiket.id;
            newTicketMessage.sentAt = (0, moment_1.default)().format();
            newTicketMessage.createdByType = Tickets_1.UserType.BUYER;
            ...
            newTicketLog.actionBy = request.user.id;
            newTicketLog.actionByType = Tickets_1.UserType.BUYER;
            ...
            const message = emailContent.content.replace('{name}', customer.firstName).replace('{subject}', savedTiket.subject);
            const mailContents = {};
    ...
    // Retrieve tickets
    /**
     * @api {get} /api/customer-support-ticket Get Customer Support Ticket API
     * @apiGroup Customer Support Ticket
     * @apiDescription This API retrieves a list of customer support tickets based on the provided query parameters.
     *
     * @apiParam (Query parameters) {Number} limit Limit for the number of tickets to retrieve.
     * @apiParam (Query parameters) {Number} offset Offset for pagination.
     * @apiParam (Query parameters) {String} keyword Keyword to search tickets.
     * @apiParam (Query parameters) {Number} count A flag to specify if the count of tickets should be returned.
     *
     * @apiHeader {String} Authorization Bearer token is required.
     *
     * @apiSuccessExample {json} Success Response
     ...
     * HTTP/1.1 500 Internal Server Error
     * {
     *   "message": "Failed to retrieve customer support ticket",
     *   "status": "0"
     * }
     */
    ...
    /**
     * @api {get} /api/customer-support-ticket/:id Get Customer Support Ticket Details API
     * @apiGroup Customer Support Ticket
     * @apiDescription This API retrieves the details of a specific customer support ticket based on the provided ticket ID.
     *
     ...
     * }
     *
     * @apiSampleRequest /api/customer-support-ticket/:id
     *
     * @apiErrorExample {json} Error Response
     * HTTP/1.1 500 Internal Server Error
     * {
    ...
    /**
     * @api {put} /api/customer-support-ticket/:id Update Customer Support Ticket Status API
     * @apiGroup Customer Support Ticket
     * @apiDescription This API updates the status of a specific customer support ticket based on the provided ticket ID.
     *
     * @apiParam (URL parameters) {Number} id Ticket ID.
     ...
     * HTTP/1.1 500 Internal Server Error
     * {
     *   "message": "Failed to update customer support ticket status",
     *   "status": "0"
     * }
     */
    updateTicketStatus(id, status, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (updateTicket.status === 3) {
                ...
                const customer = yield this.customerService.findOne({ where: { id: request.user.id } });
                const message = emailContent.content.replace('{name}', customer.firstName).replace('{subject}', updateTicket.subject);
                const mailContents = {};
                mailContents.logo = settings;
                mailContents.emailContent = message;
                mailContents.redirectUrl = '';
                mailContents.productDetailData = '';
                mailContents.ccEmail = adminUserNames;
                mail_services_1.MAILService.sendMail(mailContents, customer.username, emailContent.subject, false, false, '');
            }
            return response.status(200).send({
                status: 1,
...
exports.CustomerTicketController = CustomerTicketController;
tslib_1.__decorate([
...
], CustomerTicketController.prototype, "getParentCategory", null);
tslib_1.__decorate([
    (0, routing_controllers_1.UseBefore)(checkTokenMiddleware_1.CheckCustomerMiddleware),
    ...
    tslib_1.__metadata("design:returntype", Promise)
], CustomerTicketController.prototype, "createTicket", null);
tslib_1.__decorate([
    (0, routing_controllers_1.UseBefore)(checkTokenMiddleware_1.CheckCustomerMiddleware),
    ...
    tslib_1.__metadata("design:returntype", Promise)
], CustomerTicketController.prototype, "getTicketlist", null);
tslib_1.__decorate([
    (0, routing_controllers_1.UseBefore)(checkTokenMiddleware_1.CheckCustomerMiddleware),
    ...
    tslib_1.__metadata("design:returntype", Promise)
], CustomerTicketController.prototype, "getTicket", null);
tslib_1.__decorate([
    (0, routing_controllers_1.UseBefore)(checkTokenMiddleware_1.CheckCustomerMiddleware),
    ...
    tslib_1.__metadata("design:returntype", Promise)
], CustomerTicketController.prototype, "updateTicketStatus", null);
exports.CustomerTicketController = CustomerTicketController = tslib_1.__decorate([
    (0, routing_controllers_1.UseBefore)(AddonValidationMiddleware_1.CheckAddonMiddleware),
    (0, typedi_1.Service)(),
    (0, routing_controllers_1.JsonController)('/customer-support-ticket'),
...
//# sourceMappingURL=CustomerTicketController.js.map