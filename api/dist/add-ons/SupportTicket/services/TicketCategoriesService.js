...
const TicketCategoriesRepository_1 = require("../repositories/TicketCategoriesRepository");
...
let TicketCategoriesService = class TicketCategoriesService {
    constructor(ticketCategoriesRepository, log) {
    ...
    create(ticketCategory) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.log.info('Create a new ticketCategory ');
            return this.ticketCategoriesRepository.repository.save(ticketCategory);
        });
    }
    // find Condition
    findOne(ticketCategory) {
        return this.ticketCategoriesRepository.repository.findOne(ticketCategory);
    }
    ...
    list(limit, offset, select = [], relations = [], search = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.ticketCategoriesRepository.repository.count(condition);
        }
        else {
            return this.ticketCategoriesRepository.repository.find(condition);
        }
    }
    // listByQueryBuilder
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(TicketCategories_1.TicketCategories).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.ticketCategoriesRepository.repository.delete(id);
        });
    }
};
exports.TicketCategoriesService = TicketCategoriesService;
exports.TicketCategoriesService = TicketCategoriesService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
    tslib_1.__param(1, (0, Logger_1.Logger)(__filename)),
    tslib_1.__metadata("design:paramtypes", [TicketCategoriesRepository_1.TicketCategoriesRepository, Object])
], TicketCategoriesService);
//# sourceMappingURL=TicketCategoriesService.js.map