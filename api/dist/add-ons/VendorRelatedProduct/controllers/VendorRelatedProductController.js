...
let AdminVendorRelatedProductController = class AdminVendorRelatedProductController {
    constructor(vendorProductService, orderProductService, relatedProductService, productToCategoryService, categoryService, productService, productImageService) {
     ...
     * @apiErrorExample  {json} ProductRelated error
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    vendorProductList(limit, offset, productName, sku, status, keyword, price, count, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (keyword && keyword !== '') {
                searchConditions.push({
                    name: ['product.keywords', 'product.name', 'customer.first_name', 'product.sku', 'product.price'],
            ...
            const productList = vendorProductList.map((value) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                temp.vendorRelatedCount = yield this.relatedProductService.productRelatedCount(value.productId);
                return temp;
            }));
    ...
    /**
     * @api {Get} /api/vendor-related-product/vendor-related-product-details/:id Vendor Related product details api
     * @apiGroup Vendor Related Product
     * @apiHeader {String} Authorization
    ...
    vendorRelatedProductDetail(productId, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const ifExistProduct = yield this.productService.findOne({
                select: ['productId', 'description', 'sku', 'name', 'price'],
                where: { productId: ifExistVendorProductDetails.productId }, relations: ['productImage'],
            });
            if (!ifExistProduct) {
                const errorResponse = {
                    status: 0,
            ...
            const productToCategory = yield this.productToCategoryService.findAll({ where: { productId } });
            const category = yield this.categoryService.find({ where: { categoryId: (0, typeorm_1.In)(productToCategory.map((val => val.categoryId))) }, select: ['categoryId', 'name'] });
            ifExistProduct.vendorRelatedProduct = yield this.relatedProductService.find({
                ...
                const vendorRelatedData = val.map((values) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    ...
                    temp.containerName = (yield this.productImageService.findOne({ select: ['containerName'], where: { productId: values.relatedProductId, defaultImage: 1 } })).containerName;
                    temp.image = (yield this.productImageService.findOne({ select: ['image'], where: { productId: values.relatedProductId, defaultImage: 1 } })).image;
...
exports.AdminVendorRelatedProductController = AdminVendorRelatedProductController = tslib_1.__decorate([
    (0, routing_controllers_1.UseBefore)(AddonValidationMiddleware_1.CheckAddonMiddleware),
    (0, typedi_1.Service)(),
    (0, routing_controllers_1.JsonController)('/vendor-related-product'),
    tslib_1.__metadata("design:paramtypes", [VendorProductService_1.VendorProductService, OrderProductService_1.OrderProductService, ProductRelatedService_1.ProductRelatedService, ProductToCategoryService_1.ProductToCategoryService, CategoryService_1.CategoryService, ProductService_1.ProductService, ProductImageService_1.ProductImageService])
