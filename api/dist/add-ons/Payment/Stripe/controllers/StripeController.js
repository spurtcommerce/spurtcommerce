...
let StripeController = class StripeController {
    ...
    // Process stripe Payment API
    /**
     * @api {get} /api/stripe-payment/process/:id Process Stripe Payment API
     * @apiGroup stripe
     * @apiHeader {string} orderPrefixId
     * @apiSuccessExample {json} Success
     * HTTP/1.1 200 OK
     * {
     *      "status": "1"
     * }
     * @apiSampleRequest /api/stripe-payment/process/:id
     * @apiErrorExample {json} stripe error
    ...
    processRoute(orderPrefixId, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const stripeOrderRepository = (0, typeormLoader_1.getDataSource)().getRepository(StripeOrder_1.StripeOrder);
    ...
    // Success stripe Payment API
    /**
     * @api {get} /api/stripe-payment/process-api/:orderPrefixId  Payment SuccessAPI
     * @apiGroup stripe
     ...
     *      "status": "1"
     * }
     * @apiSampleRequest /api/stripe-payment/process-api/:orderPrefixId
     * @apiErrorExample {json} stripe error
     * HTTP/1.1 500 Internal Server Error
     */
    success(req, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const pluginRepository = (0, typeormLoader_1.getDataSource)().getRepository(Plugin_1.Plugins);
            const stripeOrderRepository = (0, typeormLoader_1.getDataSource)().getRepository(StripeOrder_1.StripeOrder);
            const stripeOrderTransactionRepository = (0, typeormLoader_1.getDataSource)().getRepository(StripeOrderTransaction_1.StripeOrderTransaction);
            const pluginDetail = yield pluginRepository.findOne({
                where: {
                    pluginName: 'stripe',
                },
            ...
            if (session) {
                ...
                const orderRepository = (0, typeormLoader_1.getDataSource)().getRepository(Order_1.Order);
                const orderData = yield orderRepository.findOne({ where: { orderId: stripeDetail.orderId } });
                if (!orderData) {
                    return response.status(400).send({
                        status: 1,
                        message: 'Invalid Order Id',
