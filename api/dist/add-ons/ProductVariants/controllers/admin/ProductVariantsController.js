...
let ProductVariantsController = class ProductVariantsController {
    ...
    /**
     * @api {Get} /api/product-variant Product Variant Product List API
     * @apiGroup Product
     ...
     *      }
     * }
     * @apiSampleRequest /api/product-variant
     * @apiErrorExample {json} productList error
     * HTTP/1.1 500 Internal Server Error
     */
    productList(limit, offset, keyword, sku, status, productType, productName, price, count, response) {
    ...
    /**
     * @api {Get} /api/product-variant/product/:id Product Variants Product Detail API
     * @apiGroup Product
     * @apiHeader {String} Authorization
     * @apiSuccessExample {json} Success
     * HTTP/1.1 200 OK
     ...
     *    }
     * }
     * @apiSampleRequest /api/product-variant/product/:id
    ...
    productDetail(id, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            productDetails.hasOrder = yield this.orderProductService.findOne({ where: { productId: productDetail.productId } });
    ...
    /**
     * @api {Get} /api/product-variants/inventory Product Varient Inventory List API
     * @apiGroup Product
     * @apiHeader {String} Authorization
     * @apiParam (Request body) {Number} limit limit
     * @apiParam (Request body) {Number} offset offset
     ...
     *      }
     * }
     * @apiSampleRequest /api/product-variants/inventory
     * @apiErrorExample {json} productList error
     * HTTP/1.1 500 Internal Server Error
     */
    ...
    // Update stock  API
    /**
     * @api {Put} /api/product-variants/stock Update Stock API
     * @apiGroup Product
     * @apiHeader {String} Authorization
     ...
     *         }
     * }
     * @apiSampleRequest /api/product-variants/stock
     * @apiErrorExample {json} manageStock error
     * HTTP/1.1 500 Internal Server Error
     */
    ...
    /**
     * @api {Post} /api/product-variant Product Variants Update Product API
     * @apiGroup Product
     * @apiHeader {String} Authorization
     * @apiParam (Request body) {Number} productId productId
    ...
    updateProduct(product, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (product.reShuffle) {
                yield this.productVarientService.delete({ productId: updateProduct.productId });
                const existingProductVariantOptions = yield this.productVarientOptionService.findAll({ where: { productId: updateProduct.productId } });
                const skuIds = existingProductVariantOptions.map((existingProductVariantOption) => existingProductVariantOption.skuId);
                yield this.skuService.delete({ id: (0, typeorm_1.In)(skuIds) });
            }
            ...
            if (varientOptions.length > 0) {
                ...
                for (const varientOption of varientOptions) {
                    if (varientOption.id) {
                        ...
                        if (pdtVarientOption) {
                            ...
                            if (sku) {
                                ...
                                if (variantDiscountPrice.length > 0) {
                                    ...
                                    for (const discountValue of variantDiscountPrice) {
                                        ...
                                        const findVariantDiscount = yield this.productDiscountService.findOne({ where: { productDiscountId: discountValue === null || discountValue === void 0 ? void 0 : discountValue.id } });
                                ...
                                if (variantSpecialPrice.length > 0) {
                                    ...
                                    for (const specialValue of variantSpecialPrice) {
                                        ...
                                        const findVariantSpecial = yield this.productSpecialService.findOne({ where: { productSpecialId: specialValue === null || specialValue === void 0 ? void 0 : specialValue.id } });
                                        ...
                                        productSpecial.customerGroupId = (_c = specialValue.customerGroupId) !== null && _c !== void 0 ? _c : 0;
                            ...
                            if (varientOption.optionImage) {
                                ...
                                for (const varientOptionsImage of varientOptionsImages) {
                                    ...
                                    newProductVarientOptionImage.sortOrder = varientOptionsImage.sortOrder;
                        ...
                        // create variant discount price
                        const variantDiscountPrice = (_d = varientOption.variantDiscountPrice) !== null && _d !== void 0 ? _d : [];
                        if (variantDiscountPrice.length > 0) {
                            const createDiscountArr = [];
                            for (const discountValue of variantDiscountPrice) {
                                if (varientOption.price <= discountValue.price) {
                        ...
                        // create variant special price
                        const variantSpecialPrice = (_e = varientOption.variantSpecialPrice) !== null && _e !== void 0 ? _e : [];
                        if (variantSpecialPrice.length > 0) {
                            const createSpecialArr = [];
                            for (const specialValue of variantSpecialPrice) {
                                if (varientOption.price < specialValue.price) {
                                ...
                                productSpecial.customerGroupId = (_f = specialValue.customerGroupId) !== null && _f !== void 0 ? _f : 0;
    ...
    /**
     * @api {Get} /api/product-variants/sku Update Product Id In Sku API
     * @apiGroup Product
     * @apiHeader {String} Authorization
     * @apiParam (Request body) {Number} limit limit
     * @apiParam (Request body) {Number} offset offset
     ...
     *      "message": "Successfully got the complete product list",
     * }
     * @apiSampleRequest /api/product-variants/sku
     * @apiErrorExample {json} updateProductList error
     * HTTP/1.1 500 Internal Server Error
     */
    updateProductList(limit, offset, count, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const select = ['productId', 'skuId', 'isSimplified', 'isSpecification'];
            const relation = [];
            const WhereConditions = [];
     ...
     * @apiErrorExample {json} DeleteProductVarient error
     * HTTP/1.1 500 Internal Server Error
     */
    ...
    // Delete Product Varient Option API
    /**
     * @api {Delete} /api/product-variants/variant-option/:id Delete Product Varient Option API
     * @apiGroup Product
     * @apiHeader {String} Authorization
     * @apiSuccessExample {json} Success
     * HTTP/1.1 200 OK
     ...
     *      "status": "1"
     * }
     * @apiSampleRequest /api/product-variants/variant-option/:id
     * @apiErrorExample {json} Delete ProductVarientOption error
     * HTTP/1.1 500 Internal Server Error
     */
...
tslib_1.__decorate([
    ...
    // @Authorized(['admin', 'variant-product-list'])
    ,
...
exports.ProductVariantsController = ProductVariantsController = tslib_1.__decorate([
