...
let MasterVariantsController = class MasterVariantsController {
     ...
     * @apiErrorExample {json} createPage error
     ...
     * }
     * @apiSampleRequest /api/variants/:id
     * @apiErrorExample {json} deleteVariant error
     * HTTP/1.1 500 Internal Server Error
     */
...
exports.MasterVariantsController = MasterVariantsController = tslib_1.__decorate([
