...
let ProductVarientOptionService = class ProductVarientOptionService {
    ...
    // find one condition
    findOne(data) {
        return this.productVarientOptionRepository.repository.findOne(data);
    }
    // variant Count
    variantCount(id) {
    ...
    findAll(data) {
        ...
        return this.productVarientOptionRepository.repository.find(data);
    }
    // list
    list(limit, offset, select = [], relation = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.productVarientOptionRepository.repository.count(condition);
        }
        else {
            return this.productVarientOptionRepository.repository.find(condition);
        }
    }
    // create
    create(productVarient) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newVarientOption = yield this.productVarientOptionRepository.repository.save(productVarient);
    ...
    update(id, productVarient) {
        ...
        return this.productVarientOptionRepository.repository.save(productVarient);
    }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newProductVarientOption = yield this.productVarientOptionRepository.repository.delete(id);
            return newProductVarientOption;
        });
    }
    bulkDelete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productVarientOptionRepository.repository.delete(id);
        });
    }
};
exports.ProductVarientOptionService = ProductVarientOptionService;
exports.ProductVarientOptionService = ProductVarientOptionService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
