...
const CouponUsageProductRepository_1 = require("../repository/CouponUsageProductRepository");
...
let CouponUsageProductService = class CouponUsageProductService {
    ...
    create(country) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.couponUsageProductRepository.repository.save(country);
        });
    }
    // findCondition
    findOne(country) {
        return this.couponUsageProductRepository.repository.findOne(country);
    }
    // update country
    update(id, country) {
        country.id = id;
    ...
    list(limit, offset, select = [], search = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.couponUsageProductRepository.repository.count(condition);
        }
        else {
            return this.couponUsageProductRepository.repository.find(condition);
        }
    }
    // delete Country
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.couponUsageProductRepository.repository.delete(id);
        });
    }
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(CouponUsageProduct_1.CouponUsageProduct).createQueryBuilder('CouponUsageProduct');
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
exports.CouponUsageProductService = CouponUsageProductService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
