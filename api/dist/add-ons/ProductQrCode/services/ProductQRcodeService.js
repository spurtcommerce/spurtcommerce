...
let ProductQRcodeService = class ProductQRcodeService {
    ...
    create(productQRcode) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.productQRcodeRepository.repository.save(productQRcode);
        });
    }
    findOne(productQRcode) {
        return this.productQRcodeRepository.repository.findOne(productQRcode);
    }
    find(productQRcode) {
        return this.productQRcodeRepository.repository.find(productQRcode);
    }
    delete(id) {
        return this.productQRcodeRepository.repository.delete(id);
    }
    list(limit, offset, select = [], search = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.productQRcodeRepository.repository.count(condition);
        }
        else {
            return this.productQRcodeRepository.repository.find(condition);
        }
    }
};
exports.ProductQRcodeService = ProductQRcodeService;
exports.ProductQRcodeService = ProductQRcodeService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
