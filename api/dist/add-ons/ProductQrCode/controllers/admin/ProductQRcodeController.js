...
let ProductQRcodeController = class ProductQRcodeController {
    ...
    imgFunction(productQRcodeRequest, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const data of productdata) {
                ...
                const findQr = yield this.productQRcodeService.findOne({ where: { productId: data.productId } });
                if (findQr) {
                    Val.id = findQr.id;
                }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const data of products) {
                ...
                if (!datas) {
                    ...
                    const val = yield this.productQRcodeService.delete({ id: valuess.id });
                    arr.push(val);
                }
            }
            if (arr) {
    ...
    /**
     * @api {Get} /api/qrCode/download-qrimage/:productId Product QR download API
     * @apiGroup qrCode
     * @apiHeader {String} Authorization
     * @apiParam (Request body) {string} productId productId
    ...
    // Qr qr-list  API
    /**
     * @api {get} /api/qrCode/qr-list Product Qr List API
     * @apiGroup qrCode
     * @apiHeader {String} Authorization
    ...
    // product-details  API
    /**
     * @api {get} /api/qrCode/product-details/:id Product Detail API
     * @apiGroup qrCode
     * @apiHeader {String} Authorization
    ...
    deleteProduct(Id, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const validId = yield this.productQRcodeService.delete({ id: value.id });
            if (!validId) {
                const errorResponse = {
                    status: 0,
    ...
    // Product List API
    /**
     * @api {get} /api/qrCode/product-listProduct List API
     * @apiGroup Product
     * @apiHeader {String} Authorization
     * @apiParam (Request body) {Number} limit limit
     * @apiParam (Request body) {Number} offset offset
     ...
     *                }]"
     *    }
     * @apiSampleRequest /api/qrCode/product-list
     * @apiErrorExample {json} productList error
     * HTTP/1.1 500 Internal Server Error
     */
    // Get product List
    productList(limit, offset, keyword, sku, productName, categoryName, status, price, count, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const select = [
            ...
            if (keyword === null || keyword === void 0 ? void 0 : keyword.trim()) {
                searchConditions.push({
                    name: ['Product.name', 'Product.sku', 'Product.keywords'],
                    value: keyword,
                });
            }
...
tslib_1.__decorate([
    ...
    tslib_1.__param(5, (0, routing_controllers_1.QueryParam)('categoryName')),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Number, String, String, String, String, String, Number, Object, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], ProductQRcodeController.prototype, "productList", null);
exports.ProductQRcodeController = ProductQRcodeController = tslib_1.__decorate([
