...
(function (HomePageWidget) {
    HomePageWidget[HomePageWidget["MAX_LIMIT"] = 10] = "MAX_LIMIT";
...
let WidgetController = class WidgetController {
    ...
    createWidget(widgetParam, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            newWidget.widgetLongTitle = (_a = widgetParam.widgetLongTitle) !== null && _a !== void 0 ? _a : widgetParam.title;
    ...
    deleteWidget(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteWidget = yield this.widgetService.delete({ widgetId: widget.widgetId });
            if (deleteWidget) {
                const successResponse = {
                    status: 1,
                    message: 'Widget deleted successfully.',
    ...
    updateWidget(id, widgetParam, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            widget.widgetLongTitle = (_a = widgetParam.widgetLongTitle) !== null && _a !== void 0 ? _a : widgetParam.title;
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    productList(limit, offset, keyword, sku, isVisible, status, price, count, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
tslib_1.__decorate([
    ...
    tslib_1.__param(4, (0, routing_controllers_1.QueryParam)('isVisible')),
...
exports.WidgetController = WidgetController = tslib_1.__decorate([
