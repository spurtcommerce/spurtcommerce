    ...
    up(queryRunner) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (exist.length === 0) {
                ...
                const val = yield (0, typeormLoader_1.getDataSource)().getRepository('PermissionModuleGroup').save(WidgetPermissionGroupSeed);
                if (val) {
                    ...
                    yield (0, typeormLoader_1.getDataSource)().getRepository('PermissionModule').save(WidgetPermissionSeed);
                }
            }
        });
    }
