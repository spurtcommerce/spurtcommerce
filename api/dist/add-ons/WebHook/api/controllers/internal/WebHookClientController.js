...
let WebHookClientController = class WebHookClientController {
    ...
    sendMail(templateContentDetails_1, recipientMailId_1, mailSubject_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (templateContentDetails, recipientMailId, mailSubject, bcc = false, isAttachment = false, attachmentDetails) {
...
exports.WebHookClientController = WebHookClientController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
