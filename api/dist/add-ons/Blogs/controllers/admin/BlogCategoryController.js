...
let BlogCategoryController = class BlogCategoryController {
    constructor(blogCategoryService, blogService) {
    ...
    deleteCategory(blogCategoryId, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteCategory = yield this.blogCategoryService.delete({ blogCategoryId: categoryId });
            if (deleteCategory) {
                const successResponse = {
                    status: 1,
                    message: 'Successfully deleted category.',
    ...
    categorylist(limit, offset, status, count, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const blogCategoryList = yield this.blogCategoryService.list(limit, offset, select, [], whereConditions, sort, false);
            if (count) {
    ...
    categorycount(limit, offset, keyword, sortOrder, status, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const successResponse = {
                ...
                data: {
                    categoryCount: blogCategoryCount === null || blogCategoryCount === void 0 ? void 0 : blogCategoryCount.categoryCount,
                },
            };
            return response.status(200).send(successResponse);
        });
    ...
    updateBlogCategoryStatus(id, status, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const blog = yield this.blogService.findOne({ where: { categoryId: id } });
            if (blog) {
                return response.status(400).send({
                    status: 0,
...
exports.BlogCategoryController = BlogCategoryController = tslib_1.__decorate([
