...
exports.BlogCategoryPathService = void 0;
const tslib_1 = require("tslib");
const typedi_1 = require("typedi");
const BlogCategoryPath_1 = require("../models/BlogCategoryPath");
const BlogCategoryPathRepository_1 = require("../repositories/BlogCategoryPathRepository");
const index_1 = require("typeorm/index");
const typeormLoader_1 = require("../../../src/loaders/typeormLoader");
let BlogCategoryPathService = class BlogCategoryPathService {
    ...
    findOne(blogCategoryPath) {
        return this.categoryPathRepository.repository.findOne(blogCategoryPath);
    }
    // delete CategoryPath
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.categoryPathRepository.repository.delete(id);
            return;
        });
    }
    // categoryList
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(BlogCategoryPath_1.BlogCategoryPath).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
exports.BlogCategoryPathService = BlogCategoryPathService;
exports.BlogCategoryPathService = BlogCategoryPathService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
    tslib_1.__metadata("design:paramtypes", [BlogCategoryPathRepository_1.BlogCategoryPathRepository])
], BlogCategoryPathService);
//# sourceMappingURL=BlogCategoryPathService.js.map