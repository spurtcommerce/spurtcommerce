...
let BlogCategoryService = class BlogCategoryService {
    ...
    create(blogCategory) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.blogCategoryRepository.repository.save(blogCategory);
        });
    }
    // find One blog category
    findOne(blogCategory) {
        return this.blogCategoryRepository.repository.findOne(blogCategory);
    }
    // findAll blog category
    findAll(blogCategory) {
        return this.blogCategoryRepository.repository.find(blogCategory);
    }
    ...
    list(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], search = [], whereConditions = [], sort = {}, count) {
            const condition = {};
            ...
            if (count) {
                return this.blogCategoryRepository.repository.count(condition);
            }
            else {
                return this.blogCategoryRepository.repository.find(condition);
            }
        });
    }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.blogCategoryRepository.repository.delete(id);
        });
    }
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(BlogCategory_1.BlogCategory).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
exports.BlogCategoryService = BlogCategoryService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
