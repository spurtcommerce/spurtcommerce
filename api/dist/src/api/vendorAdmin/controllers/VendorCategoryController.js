...
let VendorCategoryController = class VendorCategoryController {
    ...
    deleteVendorCategory(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteVendor = yield this.vendorCategoryService.delete({ vendorCategoryId: id });
            if (deleteVendor) {
                const successResponse = {
                    status: 1,
...
exports.VendorCategoryController = VendorCategoryController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
