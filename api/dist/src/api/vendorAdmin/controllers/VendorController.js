...
let VendorAdminController = class VendorAdminController {
    ...
    documentService, zoneService, industryService, vendorMediaService, documentLogService, vendorOrderService, exportLogService, companyTypeService) {
                ...
                if (vendor) {
                    ...
                    if (customerParam.password === customerParam.confirmPassword) {
                        ...
                        if (customerUpdated) {
                            ...
                            newVendor.companyType = customerParam.companyType ? customerParam.companyType : undefined;
                            ...
                            account.accountType = customerParam.accountType;
                            ...
                            if (customerParam.vendorDocuments) {
                                customerParam.vendorDocuments.forEach((documents) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                                    ...
                                    newDocument.status = (_a = documents.status) !== null && _a !== void 0 ? _a : 1;
                            ...
                            if (customerParam.mailStatus === 1) {
                                const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 13 } });
    ...
    UpdateVendor(id, updateCustomerParam, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            vendor.companyType = updateCustomerParam.companyType ? updateCustomerParam.companyType : undefined;
            ...
            account.accountType = updateCustomerParam.accountType;
            vendor.bankAccount = account;
            ...
            if (updateCustomerParam.vendorDocuments) {
                updateCustomerParam.vendorDocuments.forEach((documents) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    ...
                    newDocument.isVerified = 1;
                    newDocument.isDelete = 0;
                    newDocument.status = (_b = documents.status) !== null && _b !== void 0 ? _b : 1;
                    const saveDocument = yield this.vendorDocumentService.create(newDocument);
                    const documentLog = new VendorDocumentLog_1.VendorDocumentLog();
                    documentLog.vendorDocumentId = saveDocument.id;
                    documentLog.status = VendorDocumentLog_1.DocumentLogStatus.Approved;
            ...
            if (updateCustomerParam.approvalFlag === 1) {
                if (oldVendorApprovalStatus !== 1) {
                    ...
                    const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 15 } });
                    const setting = yield this.settingService.findOne({ where: {} });
    ...
    vendorEmailStatusUpdate(id, response, emailStatus) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (Number(emailStatus) === 2) {
                ...
                const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 42 } });
                const logo = yield this.settingService.findOne({ where: {} });
    ...
    vendorApproval(id, request, response, payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            // mail
            if (payload.kycStatus === Vendor_1.KycStatus.VERIFIED) {
                const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 54 } });
                const setting = yield this.settingService.findOne({ where: {} });
                ...
                const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 55 } });
                const setting = yield this.settingService.findOne({ where: {} });
            ...
            if (payload.approvalFlag && captureVendorApprovalStatus !== 1) {
                ...
                if (vendor.approvalFlag === 1) {
                    ...
                    const vendorCustomer = yield this.customerService.findOne({ where: { id: vendor.customerId } });
                    yield this.customerService.create(vendorCustomer);
                    const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 44 } });
                    const setting = yield this.settingService.findOne({ where: {} });
    ...
    getMasterDocuments(response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const documentList = yield this.documentService.find({ where: {} });
            return response.status(200).send({
                status: 1,
...
], VendorAdminController.prototype, "companyTypeList", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorAdminController.prototype, "companyTypeDetails", null);
tslib_1.__decorate([
...
exports.VendorAdminController = VendorAdminController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
