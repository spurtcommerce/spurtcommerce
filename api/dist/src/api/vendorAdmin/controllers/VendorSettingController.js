...
let VendorAdminSettingController = class VendorAdminSettingController {
    ...
    createSettings(settings, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const settingValue = yield this.vendorGlobalSettingService.findOne({ where: {} });
            if (!settingValue) {
...
exports.VendorAdminSettingController = VendorAdminSettingController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
