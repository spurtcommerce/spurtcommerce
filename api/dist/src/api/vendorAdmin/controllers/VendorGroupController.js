            ...
            if (vendorGroupSaveResponse) {
                ...
                if (categories.length > 0) {
                    ...
                    if (vendorGroupCategoryList.length > 0) {
                        const vendorGroupCategoryids = vendorGroupCategoryList.map((groupCategoryData) => groupCategoryData.id);
                        yield this.vendorGroupCategoryService.delete({ id: (0, typeorm_1.In)(vendorGroupCategoryids) });
                    }
    ...
    deleteGroup(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (findVendorGroupCategoryList.length > 0) {
                const vendorGroupCategoryIds = findVendorGroupCategoryList.map((categoryData) => categoryData.vendorGroupId);
                yield this.vendorGroupCategoryService.delete({ id: (0, typeorm_1.In)(vendorGroupCategoryIds) });
            }
            const deleteGroup = yield this.vendorGroupService.delete({ groupId: id });
            if (deleteGroup) {
                const successResponse = {
                    status: 1,
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (sellerGroupIds) {
                ...
                for (const id of groupIds) {
                    const dataId = yield this.vendorGroupService.findOne({ where: { groupId: id } });
                    if (!dataId) {
                        const errorResponse = {
                            status: 0,
...
exports.VendorGroupController = VendorGroupController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
