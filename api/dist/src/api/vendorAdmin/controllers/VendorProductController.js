...
let VendorAdminProductController = class VendorAdminProductController {
    ...
    productApproval(id, approvalFlag, reason, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const vendorProductSave = yield this.vendorProductService.update(vendorProduct.vendorProductId, vendorProduct);
            ...
            if (vendorProductSave.approvalFlag === 1) {
                const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 16 } });
                ...
                const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 43 } });
...
exports.VendorAdminProductController = VendorAdminProductController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
