...
const CompanyTypeService_1 = require("../../../api/core/services/CompanyTypeService");
let VendorController = class VendorController {
    constructor(customerService, vendorService, emailTemplateService, vendorCategoryService, s3Service, imageService, loginLogService, vendorOrdersService, vendorProductService, settingService, currencyService, orderStatusService, accessTokenService, vendorMediaService, registrationOtpService, userService, companyTypeService) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (resultUser) {
                ...
                if (vendorInfo) {
                    ...
                    if (registerParam.password) {
                        ...
                        if (customerUpdated) {
                            ...
                            // // const logo = await this.settingService.findOne({ where: {} });
                            ...
                            if (+kycMandateCheck === 1) {
                                const emailContentVendor = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 11 } });
                                ...
                                const notMandateEmail = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 56 } });
                            ...
                            const emailContentAdmins = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 12 } });
                ...
                if (+kycMandateCheck2 === 1) {
                    const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 11 } });
    ...
    pendingStatusUpdate(id, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const emailContentAdmin = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 52 } });
            const setting = yield this.settingService.findOne({ where: {} });
            ...
            const emailContentVendor = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 53 } });
    ...
    vendorDetails(request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const vendorDetail = yield (0, marketplace_1.getVendorProfile)((0, typeormLoader_1.getDataSource)(), { vendorId: request.user.vendorId });
    ...
    forgotPassword(forgotPasswordParam, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 2 } });
            const logo = yield this.settingService.findOne({ where: {} });
    ...
    update(updateParam, customerId, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (updateParam.blogType === 'business-address') {
                ...
                vendor.companyType = updateParam.companyType;
            ...
            const account = vendor.bankAccount || {};
            // Bank Account Info
            if (updateParam.blogType === 'bank-account-info') {
                ...
                account.accountType = updateParam.bankPayload.accountType;
            }
            // Bank Address
            ...
            if (updateParam.blogType === 'basic-profile') {
                ...
                customer.firstName = updateParam.firstName;
                customer.lastName = (_a = updateParam.lastName) !== null && _a !== void 0 ? _a : '';
            ...
            // vendor media
            if (((_b = updateParam === null || updateParam === void 0 ? void 0 : updateParam.vendorMedia) === null || _b === void 0 ? void 0 : _b.length) > 0) {
                // single create check
            ...
            vendor.companyState = (_c = updateParam.state) !== null && _c !== void 0 ? _c : '';
    ...
    forgetPasswordLink(emailId, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 23 } });
            const logo = yield this.settingService.findOne({ where: {} });
    ...
    companyTypeList(responce) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const companyTypes = yield this.companyTypeService.findAll();
            const successResponse = {
                status: 1,
                message: 'successfully got the company list',
                data: companyTypes,
            };
            return responce.status(200).send(successResponse);
        });
    }
    companyTypeDetails(companyId, responce) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const companyData = yield this.companyTypeService.findOne({
                where: { id: companyId },
            });
            if (companyData) {
                const successResponse = {
                    status: 1,
                    message: 'successfully got details of company',
                    data: companyData,
                };
                return responce.status(200).send(successResponse);
            }
            ...
            return responce.status(400).send(errorResponse);
        });
    }
};
...
tslib_1.__decorate([
    (0, routing_controllers_1.Get)('/company-list'),
    (0, routing_controllers_1.Authorized)('vendor'),
    tslib_1.__param(0, (0, routing_controllers_1.Res)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], VendorController.prototype, "companyTypeList", null);
tslib_1.__decorate([
    (0, routing_controllers_1.Get)('/company-list/:id'),
    (0, routing_controllers_1.Authorized)('vendor'),
    tslib_1.__param(0, (0, routing_controllers_1.Param)('id')),
    tslib_1.__param(1, (0, routing_controllers_1.Res)()),
    tslib_1.__metadata("design:type", Function),
    ...
    tslib_1.__metadata("design:returntype", Promise)
], VendorController.prototype, "companyTypeDetails", null);
exports.VendorController = VendorController = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [CustomerService_1.CustomerService,
        ...
        CompanyTypeService_1.CompanyTypeService])
], VendorController);
