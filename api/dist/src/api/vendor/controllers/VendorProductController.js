...
let VendorProductController = class VendorProductController {
    ...
    createProduct(product, req, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if ((product.isGrouped !== 1 && product.tax < 0)) {
                const errorResponse = {
                    status: 0,
            ...
            if (product.isGrouped !== 1 && +newProduct.price === 0) {
                return response.status(400).send({
                    status: 0,
            ...
            if (productImage.length === 0) {
                return response.status(400).send({
                    status: 0,
                    message: 'Error ! Atleast one selction is mandatory',
                });
            }
            ...
            const serviceCharge = {};
            serviceCharge.productCost = product.isGrouped !== 1 ? product.price : 0;
            serviceCharge.packingCost = (_b = product.packingCost) !== null && _b !== void 0 ? _b : 0;
            serviceCharge.shippingCost = (_c = product.shippingCost) !== null && _c !== void 0 ? _c : 0;
            serviceCharge.tax = 0;
            serviceCharge.others = (_d = product.others) !== null && _d !== void 0 ? _d : 0;
            ...
            if (product.isGrouped !== 1) {
                newProduct.taxType = (_e = product.taxType) !== null && _e !== void 0 ? _e : 0;
                newProduct.taxValue = (_f = product.tax) !== null && _f !== void 0 ? _f : 0;
            }
            else {
                newProduct.taxType = 0;
                newProduct.taxValue = 0;
            }
            if (product.isGrouped !== 1 && product.productType === 'physical') {
                newProduct.quantity = (_g = product.quantity) !== null && _g !== void 0 ? _g : 1;
                newProduct.stockStatusId = (_h = product.outOfStockStatus) !== null && _h !== void 0 ? _h : 1;
            }
            else {
                newProduct.quantity = 0;
                newProduct.stockStatusId = 0;
            }
            ...
            if (product.isGrouped !== 1 && product.productType === 'physical') {
                newSku.quantity = (_j = product.quantity) !== null && _j !== void 0 ? _j : 1;
            }
            else {
                newSku.quantity = 0;
            }
            newSku.skuName = product.sku;
            newSku.price = product.isGrouped !== 1 ? newProduct.price : 0;
            newSku.isActive = 1;
            ...
            newProduct.isSubscription = 0;
            newProduct.isSpecification = product.isSpecification;
            newProduct.isGrouped = (_k = product.isGrouped) !== null && _k !== void 0 ? _k : 0;
            newProduct.isVisible = 1;
            ...
            // Product Discount
            if (product.isGrouped !== 1 && product.productDiscount) {
            ...
            // Product Special
            if (product.isGrouped !== 1 && product.productSpecial) {
            ...
            // product tire price
            if (product.isGrouped !== 1 && product.tirePrices) {
                ...
                for (const tire of tirePrice) {
                    ...
                    productTirePrice.quantity = (_l = tire.quantity) !== null && _l !== void 0 ? _l : 0;
            ...
            const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 51 } });
    ...
    //         newProduct.stockStatusId = product.outOfStockStatus ?? 1;
    //     } else {
    //         newProduct.quantity = 0;
    //         newProduct.stockStatusId = 0;
    //     }
    ...
    //     newProduct.stockStatusId = product.productType === 'physical' ? product.outOfStockStatus ?? 1 : 0;
    //     newSku.skuName = product.sku;
    //     newSku.price = newProduct.price;
    //     newSku.quantity = product.productType === 'physical' ? (product.quantity ?? 1) : 0;
    //     newSku.isActive = 1;
    ...
    //             productTirePrice.productId = saveProduct.productId;
    //             productTirePrice.quantity = tire.quantity ?? 0;
    //             productTirePrice.price = tire.price;
    ...
    //     const setting = await this.settingService.findOne({ where: {} });
    //     // const product = await this.productService.findOne({ select: ['name'], where: { productId: id } });
    //     const message = emailContent.content.replace('{name}', 'Admin').replace('{sellerName}', req.user.customer.firstName).replace('{productName}', product.productName);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of splitProduct) {
                ...
                if (isNotApprovedProduct) {
                    ...
                    const productSku = yield this.skuService.findOne({ where: { id: findProduct.skuId } });
    ...
    updateProduct(id, product, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (product.isGrouped !== 1 && validateDiscountPrice.length > 0) {
            ...
            if (product.isGrouped !== 1 && validateSpecialPrice.length > 0) {
                validatedSpecial = validateSpecialPrice.some(specialData => specialData.specialPrice < 0);
            }
            if (product.isGrouped !== 1 && validatedDiscount || validatedSpecial || (product.price < 0)) {
                const errorResponse = {
                    status: 0,
            ...
            if (findSku) {
                ...
                if (finddSku) {
                    ...
                    findSku.price = product.isGrouped !== 1 ? product.price : 0;
                    findSku.quantity = product.isGrouped !== 1 ? (product.productType === 'physical' ? product.quantity : 0) : 0;
                    findSku.isActive = 1;
                ...
                newSku.quantity = product.isGrouped !== 1 ? (product.productType === 'physical' ? product.quantity : 0) : 0;
                newSku.isActive = 1;
            ...
            updateProduct.taxType = product.isGrouped !== 1 ? ((_d = product.taxType) !== null && _d !== void 0 ? _d : 0) : 0;
            updateProduct.taxValue = product.isGrouped !== 1 ? ((_e = product.tax) !== null && _e !== void 0 ? _e : 0) : 0;
            updateProduct.hasTirePrice = (_f = product.hasTirePrice) !== null && _f !== void 0 ? _f : 0;
            ...
            if (product.isGrouped !== 1 && product.tirePrices) {
                ...
                for (const tire of tirePrice) {
                    ...
                    productTirePrice.quantity = product.productType === 'physical' ? tire.quantity : undefined;
                    productTirePrice.price = tire.price;
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    vendorProductList(limit, offset, status, isVisible, keyword, price, approvalFlag, productName, vendorName, updatedOn, sortBy, sortOrder, count, sku, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    deleteProduct(productid, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const product = yield this.productService.findOne({ where: { productId: productid } });
            if (!product) {
                const errorResponse = {
                    status: 0,
                    message: 'Invalid productId',
                ...
                for (const fileNames of mainFiles) {
                    ...
                    if (fileType === 'xlsx') {
                        if (fileNames === 'productData.xlsx') {
                            ...
                            const createProduct = yield this.productController.bulkProductImport(productsWithVendorId, authorization, request.user.id);
                            rimraf(path.join(process.cwd(), 'product_' + random), ((err) => {
                                if (err) {
                                    throw err;
                                }
                    ...
                    else if (fileNames !== 'productData.xlsx' && fileNames !== 'image.zip') {
                        rimraf(path.join(process.cwd(), 'product_' + random), ((err) => {
                            if (err) {
                                throw err;
                            }
                        ...
                        fs.unlinkSync(mainFileName);
                        throw new Error(`Unwanted file found: ${fileNames}. Only productData.xlsx and optional image.zip allowed`);
                    }
                }
                rimraf(path.join(process.cwd(), 'product_' + random), ((err) => {
                    if (err) {
    ...
    ExportAllProductsById(productId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const product of productsid) {
                const data = yield this.productService.findOne({ where: { productId: product } });
    ...
    excelProductView(productId, price, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const rows = [];
            const productIds = yield (0, marketplace_1.vendorProductList)((0, typeormLoader_1.getDataSource)(), pluginLoader_1.pluginModule, 0, 0, '', '', '', '', price, '', '', '', '', '', '', 0, request.user.vendorId).then((val) => {
    ...
    exportSelectedProducts(logId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const excel = require('exceljs');
            const workbook = new excel.Workbook();
            const worksheet = workbook.addWorksheet('All Product Excel');
            const rows = [];
            const exportLog = yield this.exportLogService.findOne({
                where: {
                    id: logId,
            ...
            let productIds = [];
            if (exportLog.recordIds) {
                productIds = exportLog.recordIds
                    .split(',')
                    .map((id) => Number(id))
                    .filter((id) => !isNaN(id));
            }
            worksheet.columns = [
                ...
                { header: 'Subtract Stock', key: 'subtractStock', width: 15 },
            ...
            const vendorProductLists = yield this.vendorProductService.listByQueryBuilder(0, 0, selects, whereConditions, [], relations, [], sort, false, true);
            for (const product of vendorProductLists) {
                const description = (_b = (_a = product.description) === null || _a === void 0 ? void 0 : _a.replace(/(&nbsp;|(<([^>]+)>))/gi, '')) !== null && _b !== void 0 ? _b : '';
                rows.push([
                    product.productId,
                    product.name,
                    description.trim(),
...
tslib_1.__decorate([
    ...
    tslib_1.__param(9, (0, routing_controllers_1.QueryParam)('updatedOn')),
    tslib_1.__param(10, (0, routing_controllers_1.QueryParam)('sortBy')),
...
tslib_1.__decorate([
    (0, routing_controllers_1.Get)('/product-excel-list/:logId'),
    (0, routing_controllers_1.Authorized)('vendor'),
    tslib_1.__param(0, (0, routing_controllers_1.Param)('logId')),
    tslib_1.__param(1, (0, routing_controllers_1.Req)()),
    tslib_1.__param(2, (0, routing_controllers_1.Res)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], VendorProductController.prototype, "exportSelectedProducts", null);
tslib_1.__decorate([
...
exports.VendorProductController = VendorProductController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
