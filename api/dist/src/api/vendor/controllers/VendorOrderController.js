...
let VendorOrderController = class VendorOrderController {
    ...
    deleteOrder(orderid, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteOrder = yield this.orderService.delete({ orderId: orderid });
            if (deleteOrder) {
                const successResponse = {
                    status: 1,
                    message: 'Order Deleted Successfully',
    ...
    updateOrderStatus(vendorOrderId, subOrderStatusId, fullfillmentStatusId, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (orderStatusUpdate) {
                const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 21 } });
                const logo = yield this.settingService.findOne({ where: {} });
                const order = yield this.orderService.findOrder({ where: { orderId: orderProductStatus.orderId } });
                const orderStatus = yield this.orderStatusService.findOne({ where: { orderStatusId: subOrderStatusId } });
                const orderFullfillmentStatus = yield this.orderFullfillmentStatusService.findOne({ where: { id: fullfillmentStatusId } });
    ...
    updateShippingInformation(vendorOrderId, trackingUrl, trackingNo, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const updateOrderProduct = yield this.orderProductService.findOne({ where: { orderProductId: updateOrder.orderProductId } });
    ...
    orderExportPdf(vendorOrderId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            orderData.zoneData = zoneData !== null && zoneData !== void 0 ? zoneData : '';
            orderData.countryData = countryData !== null && countryData !== void 0 ? countryData : '';
    ...
    makeArchive(vendorOrderId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.vendorOrdersService.delete({ vendorOrderId: vendorOrder.vendorOrderId });
            const successResponse = {
                status: 1,
                message: 'Successfully order archived',
            };
    ...
    revokeArchive(vendorOrderArchiveId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.vendorOrderArchiveService.delete({ vendorOrderArchiveId: vendorOrderArchive.vendorOrderArchiveId });
            const successResponse = {
                status: 1,
    ...
    downloadOrderExportFromLog(exportLogId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const excel = require('exceljs');
            // Find export log
            ...
            const recordIds = [];
            if (exportLog.referenceId && Number.isInteger(exportLog.referenceId)) {
                recordIds.push(exportLog.referenceId);
            }
            if (!recordIds.length) {
                return response.status(400).send({
                    status: 0,
                    message: 'No valid order IDs found in export log',
                });
            }
            ...
            // Build query
            const select = [
                'COUNT(OrderProduct.orderProductId) as NoOfItems',
                'MAX(OrderProduct.orderProductId) as orderProductId',
                'orders.createdDate as createdDate',
                'orders.email as email',
                'orders.telephone as telephone',
                'orders.orderPrefixId as orderPrefixId',
                'orders.orderId as orderId',
                'orders.shippingFirstname as shippingFirstname',
                'orders.shippingLastname as shippingLastname',
                'orders.total as total',
                'orders.currencyCode as currencyCode',
                'orders.currencySymbolLeft as currencySymbolLeft',
                'orders.currencySymbolRight as currencySymbolRight',
                'MAX(OrderProduct.orderStatusId) as orderStatusId',
                'orders.modifiedDate as modifiedDate',
                'orders.shippingAddress1 as shippingAddress1',
                'orders.shippingAddress2 as shippingAddress2',
                'orders.shippingCity as shippingCity',
                'orders.shippingPostcode as shippingPostcode',
                'orders.shippingZone as shippingZone',
            ];
            const relations = [
                { tableName: 'OrderProduct.order', aliasName: 'orders' }, // renamed alias
            ];
            const groupBy = [{ name: 'OrderProduct.orderId' }];
            const whereConditions = [
                { name: 'orders.orderId', op: 'IN', value: recordIds },
            ];
            const searchConditions = [];
            const sort = [{ name: 'orders.createdDate', order: 'DESC' }];
            // Fetch orders
            ...
            if (!orderList.length) {
                console.log('No orders found, downloading empty excel');
            }
            // Prepare rows
    ...
    updateVendorOrderCancelStatus(orderProductId, cancelStatusId, comments, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 20 } });
            const logo = yield this.settingService.findOne({ where: {} });
            let status;
            let res;
    ...
    exportCancelRequest(orderProductId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of orderid) {
                ...
                if (vendorOrder) {
                    const data = yield this.orderProductService.findOne({ where: { orderProductId: id } });
                    const dataId = yield this.orderService.findOrder({ where: { orderId: data.orderId } });
                    let status;
    ...
    orderInvoiceExportSendEmailPdf(orderId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 24 } });
            const redirectUrl = env_1.env.vendorRedirectUrl;
            ...
            const failedOrderResponse = failedOrderList.map((value) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                temp.productItems = yield this.vendorInvoiceItemService.findAll({
                    ...
                    const orderProduct = val.map((values) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                        const products = yield this.orderProductService.findOne({ where: { orderProductId: values.orderProductId } });
            ...
            for (const order of failedOrderList) {
                ...
                if (productItems.length > 0) {
                    for (const items of productItems) {
                        const products = yield this.orderProductService.findOne({ where: { orderProductId: items.orderProductId } });
                        if (products) {
    ...
    exportVendorCustomerByLog(logId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const excel = require('exceljs');
            const workbook = new excel.Workbook();
            ...
            // Find export log
            const logEntry = yield this.exportLogService.findOne({
                where: {
                    id: logId,
            ...
            let customerIds = [];
            if (logEntry === null || logEntry === void 0 ? void 0 : logEntry.recordIds) {
                customerIds = logEntry.recordIds
                    .split(',')
            ...
            if (customerIds.length > 0) {
                // Fetch only related customers
                customers = yield this.customerService.find({
                    where: {
            ...
            customers.forEach((cust) => {
                ...
                worksheet.addRow({
                    ...
                    groupName: ((_a = cust.customerGroup) === null || _a === void 0 ? void 0 : _a.name) || '-',
            ...
            return new Promise((resolve, reject) => {
                response.download(fileName, (err) => {
                    ...
                    if (err) {
                        ...
                        resolve(false); // error throw panna koodathu
                    }
                    else {
                        resolve(true);
                    }
     ...
     * HTTP/1.1 500 internal server error
     */
    customerPurchasedProductList(request, response, emailId, limit, offset, count, productName, sku) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const select = [
                'orderProduct.orderProductId as orderProductId',
                'product.sku as sku',
    ...
    updatePaymentStatus(orderId, paymentStatusId, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const updateOrder = yield this.orderService.findOrder({ where: { orderId } });
            if (!updateOrder) {
                const errorResponse = {
                    status: 0,
            ...
            if (paymentStatusId === 1) {
                    ...
                    if (vendorProduct) {
                        ...
                        if (vendorOrders) {
                            ...
                            if (+vendorProduct.vendorProductCommission > 0) {
                                ...
                                const defaultCommission = yield this.vendorGlobalSettingService.findOne({ where: {} });
                ...
                const vendorOrder = yield this.vendorOrdersService.findOne({ where: { orderId } });
                if (vendorOrder) {
                    const vendorPayment = yield this.vendorPaymentService.findOne({
                        vendorOrderId: vendorOrder.vendorOrderId,
                    });
                    yield this.vendorPaymentService.delete({ vendorPaymentId: vendorPayment.vendorPaymentId });
                }
...
tslib_1.__decorate([
    (0, routing_controllers_1.Get)('/export-log-download/:id'),
    (0, routing_controllers_1.Authorized)('vendor'),
    tslib_1.__param(0, (0, routing_controllers_1.Param)('id')),
    tslib_1.__param(1, (0, routing_controllers_1.Req)()),
    tslib_1.__param(2, (0, routing_controllers_1.Res)()),
    ...
    tslib_1.__metadata("design:paramtypes", [Number, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], VendorOrderController.prototype, "downloadOrderExportFromLog", null);
tslib_1.__decorate([
...
tslib_1.__decorate([
    (0, routing_controllers_1.Get)('/customer-excel-download/:logId'),
    (0, routing_controllers_1.Authorized)(['vendor', 'export-customer']),
    ...
    tslib_1.__metadata("design:paramtypes", [Number, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], VendorOrderController.prototype, "exportVendorCustomerByLog", null);
tslib_1.__decorate([
...
exports.VendorOrderController = VendorOrderController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
