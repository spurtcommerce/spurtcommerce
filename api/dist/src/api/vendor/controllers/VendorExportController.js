    ...
    listExportLog(limit, offset, moduleName, createdDate, count, keyword, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const select = [
                ...
                'exportLog.export_id as exportId',
                'exportLog.product_type as ProductType',
            ...
            const whereconditions = [
                { name: 'exportLog.reference_id', op: 'where', value: request.user.vendorId },
            ];
            ...
            if (createdDate) {
                searchConditions.push({
                    name: 'DATE(exportLog.created_date)',
                    op: 'where',
                    value: createdDate,
                });
            }
...
exports.VendorExportLogController = VendorExportLogController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
