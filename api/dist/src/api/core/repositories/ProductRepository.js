...
let ProductRepository = class ProductRepository {
    constructor() {
        this.repository = (0, typeormLoader_1.getDataSource)().getRepository(ProductModel_1.Product);
    }
    productList(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], searchConditions = [], whereConditions = [], categoryId = [], priceFrom, priceTo, price, count) {
            const query = yield this.repository.createQueryBuilder('product');
            // Select
    ...
    recentProductSelling(limit) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield this.repository.manager.createQueryBuilder(OrderProduct_1.OrderProduct, 'orderProduct');
    ...
    validateSkuNameForVendor(productId, vendorId, skuName) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield this.repository.manager.createQueryBuilder(VendorProducts_1.VendorProducts, 'vendorProduct');
            query.select('sku.skuName');
            query.innerJoin('vendorProduct.sku', 'sku');
            query.where('vendorProduct.productId != :value ', { value: productId });
            query.andWhere('vendorProduct.vendorId != :vendorId ', { vendorId });
            query.andWhere('sku.skuName = :skuName ', { skuName });
            return query.getRawOne();
        });
    }
