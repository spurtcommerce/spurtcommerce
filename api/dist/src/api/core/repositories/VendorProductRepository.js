...
let VendorProductsRepository = class VendorProductsRepository {
    constructor() {
        this.repository = (0, typeormLoader_1.getDataSource)().getRepository(VendorProducts_1.VendorProducts);
    }
    topProductSelling(id, duration, limit) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield this.repository.manager.createQueryBuilder(VendorOrders_1.VendorOrders, 'vendorOrders');
    ...
    vendorActiveProduct(id, limit, offset) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield this.repository.createQueryBuilder('vendorProducts');
...
exports.VendorProductsRepository = VendorProductsRepository = tslib_1.__decorate([
    (0, typedi_1.Service)(),
