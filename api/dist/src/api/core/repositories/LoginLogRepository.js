...
let LoginLogRepository = class LoginLogRepository {
    constructor() {
        this.repository = (0, typeormLoader_1.getDataSource)().getRepository(LoginLog_1.LoginLog);
    }
    logList(limit) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield this.repository.createQueryBuilder('LoginLog');
...
exports.LoginLogRepository = LoginLogRepository = tslib_1.__decorate([
    (0, typedi_1.Service)(),
