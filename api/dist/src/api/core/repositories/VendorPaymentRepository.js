...
let VendorPaymentRepository = class VendorPaymentRepository {
    constructor() {
        this.repository = (0, typeormLoader_1.getDataSource)().getRepository(VendorPayment_1.VendorPayment);
    }
    //  sale count
    getTotalSales(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield this.repository.createQueryBuilder('vendorPayment');
...
exports.VendorPaymentRepository = VendorPaymentRepository = tslib_1.__decorate([
    (0, typedi_1.Service)(),
