...
let VendorOrdersRepository = class VendorOrdersRepository {
    constructor() {
        this.repository = (0, typeormLoader_1.getDataSource)().getRepository(VendorOrders_1.VendorOrders);
    }
    searchOrderList(id, orderDate, startDate, endDate, keyword, deliverylist) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield this.repository.createQueryBuilder('vendorOrder');
    ...
    productSoldBasedOnDuration(id, duration) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield this.repository.createQueryBuilder('vendorOrders');
...
exports.VendorOrdersRepository = VendorOrdersRepository = tslib_1.__decorate([
    (0, typedi_1.Service)(),
