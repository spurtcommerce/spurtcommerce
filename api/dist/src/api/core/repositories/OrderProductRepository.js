...
let OrderProductRepository = class OrderProductRepository {
    constructor() {
        this.repository = (0, typeormLoader_1.getDataSource)().getRepository(OrderProduct_1.OrderProduct);
    }
    topPerformingProduct(limit, offset, count, duration) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield this.repository.createQueryBuilder('OrderProduct');
            query.select([
...
exports.OrderProductRepository = OrderProductRepository = tslib_1.__decorate([
    (0, typedi_1.Service)(),
