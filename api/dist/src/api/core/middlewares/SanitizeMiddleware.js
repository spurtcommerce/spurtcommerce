    ...
    use(req, res, next) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (data) {
                for (const [key, value] of Object.entries(data)) {
                    if (key !== 'password' && key !== 'confirmPassword' && key !== 'newPassword' && key !== 'oldPassword' && key !== 'productDescription' && key !== 'description'
                        && key !== 'categoryDescription' && key !== 'widgetDescription' && key !== 'companyDescription' &&
                        ...
                        else if (key === 'metaTagDescription' || key === 'metaTagKeyword') {
                            if (value !== undefined && value !== null) {
                                if (!isValid4(value)) {
                                    return res.status(400).send({ status: 0, message: `Invalid character in ${key}` });
                                }
            ...
            if (data) {
                for (const [key, value] of Object.entries(data)) {
                    if (key !== 'password' && key !== 'confirmPassword' && key !== 'newPassword' && key !== 'oldPassword' && key !== 'productDescription' && key !== 'description'
                        && key !== 'categoryDescription' && key !== 'widgetDescription' && key !== 'companyDescription' && key !== 'content' && key !== 'metaTagContent') {
                        if (key === 'productName' || key === 'permission') {
                            if (!isValid2(value.toString())) {
                                return res.status(400).send({ status: 0, message: `Invalid character in ${key}` });
                            }
            ...
            if (data) {
                for (const [key, value] of Object.entries(data)) {
                    if (key !== 'password' && key !== 'confirmPassword' && key !== 'newPassword' && key !== 'oldPassword' && key !== 'productDescription' && key !== 'description' && key !== 'attribute'
                        && key !== 'categoryDescription' && key !== 'widgetDescription' && key !== 'companyDescription' && key !== 'content' && key !== 'metaTagContent' && key !== 'filter') {
...
exports.SanitizeMiddleware = SanitizeMiddleware = tslib_1.__decorate([
    (0, typedi_1.Service)(),
