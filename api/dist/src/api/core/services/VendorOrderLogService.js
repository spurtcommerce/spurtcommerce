...
let VendorOrderLogService = class VendorOrderLogService {
    ...
    create(vendorOrderLog) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newVendorOrderLog = yield this.vendorOrderLogRepository.repository.save(vendorOrderLog);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteVendorOrderLog = yield this.vendorOrderLogRepository.repository.delete(id);
...
exports.VendorOrderLogService = VendorOrderLogService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
