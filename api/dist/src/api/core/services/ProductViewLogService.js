...
let ProductViewLogService = class ProductViewLogService {
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(productViewLog_1.ProductViewLog).createQueryBuilder('ProductViewLog');
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productViewLogRepository.repository.delete(id);
        });
    }
};
exports.ProductViewLogService = ProductViewLogService;
exports.ProductViewLogService = ProductViewLogService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
