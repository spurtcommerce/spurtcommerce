...
let ExportLogService = class ExportLogService {
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(ExportLog_1.ExportLog).createQueryBuilder('exportLog');
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
    ...
    create(exportLog) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newExport = yield this.exportLogRepository.repository.save(exportLog);
            return newExport;
        });
    }
    // update exportLog
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newExport = yield this.exportLogRepository.repository.delete(id);
            return newExport;
        });
    }
    // find exportLog
...
exports.ExportLogService = ExportLogService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
