...
let SiteFilterCategoryService = class SiteFilterCategoryService {
    ...
    create(siteFilterCategory) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newSiteFilterCategory = yield this.siteFilterCategoryRepository.repository.save(siteFilterCategory);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newSiteFilter = yield this.siteFilterCategoryRepository.repository.delete(id);
...
exports.SiteFilterCategoryService = SiteFilterCategoryService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
