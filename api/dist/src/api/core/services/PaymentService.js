...
let PaymentService = class PaymentService {
    ...
    create(product) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.paymentRepository.repository.save(product);
            return newProduct;
        });
    }
    // find payment
    findAll(plugins) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.paymentRepository.repository.find(plugins);
        });
    }
    // find payment without condition
    findData() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.paymentRepository.repository.find();
        });
    }
    // payment List
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.paymentRepository.repository.delete(id);
            return newProduct;
        });
    }
    // find one plugin
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(Payment_1.Payment).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
