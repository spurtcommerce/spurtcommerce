...
let ImageService = class ImageService {
    // Bucket list
    listFolders() {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit = 0, marker = '', folderName = '') {
    ...
    generateRandomImageName(ext) {
        const random = Math.random().toString(36).substring(2, 8);
        return `prod_${Date.now()}_${random}.${ext}`;
    }
    // create folder
    ...
    // Image resize
    resizeImage() {
        return tslib_1.__awaiter(this, arguments, void 0, function* (imgName = '', imgPath = '', widthString = '', heightString = '') {
    ...
    // Image resize
    resizeImageBase64(directory_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (directory, widthString = '', heightString = '') {
    ...
    // search folders
    getFolder() {
        return tslib_1.__awaiter(this, arguments, void 0, function* (folderName = '', vendorPrefix) {
            return new Promise((resolve, reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
