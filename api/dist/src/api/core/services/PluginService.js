...
let PluginService = class PluginService {
    ...
    create(product) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.pluginRepository.repository.save(product);
            return newProduct;
        });
    }
    // find plugins
    findAll(plugins) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.pluginRepository.repository.find(plugins);
        });
    }
    // country List
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.pluginRepository.repository.delete(id);
            return newProduct;
        });
    }
    // find one plugin
...
exports.PluginService = PluginService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
