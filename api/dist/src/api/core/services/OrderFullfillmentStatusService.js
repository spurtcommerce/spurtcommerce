...
let OrderFullfillmentStatusService = class OrderFullfillmentStatusService {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.orderFulfillmentStatusRepository.repository.delete(id);
        });
    }
    // orderStatus List
...
exports.OrderFullfillmentStatusService = OrderFullfillmentStatusService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
