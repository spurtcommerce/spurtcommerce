...
let OrderStatusToFullfillmentService = class OrderStatusToFullfillmentService {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.orderStatusToFullfillmentRepository.repository.delete(id);
        });
    }
};
exports.OrderStatusToFullfillmentService = OrderStatusToFullfillmentService;
exports.OrderStatusToFullfillmentService = OrderStatusToFullfillmentService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
