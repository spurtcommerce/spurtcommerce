...
let SiteFilterSectionService = class SiteFilterSectionService {
    ...
    create(siteFilterSection) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newSiteFilterSection = yield this.siteFilterSectionRepository.repository.save(siteFilterSection);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newSiteFilter = yield this.siteFilterSectionRepository.repository.delete(id);
            return newSiteFilter;
        });
    }
};
exports.SiteFilterSectionService = SiteFilterSectionService;
exports.SiteFilterSectionService = SiteFilterSectionService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
