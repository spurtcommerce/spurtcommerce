...
let ProductVideoService = class ProductVideoService {
    ...
    create(productVideo) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newVarient = yield this.productVideoRepository.repository.save(productVideo);
            return newVarient;
        });
    }
    // update
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newVideo = yield this.productVideoRepository.repository.delete(id);
            return newVideo;
        });
    }
};
exports.ProductVideoService = ProductVideoService;
exports.ProductVideoService = ProductVideoService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
