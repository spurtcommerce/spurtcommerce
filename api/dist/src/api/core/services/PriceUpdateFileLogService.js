...
let PriceUpdateFileLogService = class PriceUpdateFileLogService {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteProductOptionValue = yield this.priceUpdateFileLogRepository.repository.delete(id);
...
exports.PriceUpdateFileLogService = PriceUpdateFileLogService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
