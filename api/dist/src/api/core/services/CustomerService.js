...
let CustomerService = class CustomerService {
    ...
    findCustomerById(customerId, select) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const condition = {};
            if (select) {
            ...
            return yield this.customerRepository.repository.findOne(condition);
        });
    }
    // update customer
    update(id, customer) {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.customerRepository.repository.delete(id);
        });
    }
    ...
    dashboardCustomerCount(duration) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.customerRepository.dashboardCustomerCount(duration);
        });
    }
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(Customer_1.Customer).createQueryBuilder();
            // Select
