...
let VendorInvoiceItemService = class VendorInvoiceItemService {
    ...
    create(vendorInvoiceItem) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newvendorInvoiceItem = yield this.vendorInvoiceItemRepository.repository.save(vendorInvoiceItem);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteVendorInvoiceItem = yield this.vendorInvoiceItemRepository.repository.delete(id);
...
exports.VendorInvoiceItemService = VendorInvoiceItemService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
