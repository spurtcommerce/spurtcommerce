...
let PermissionModuleService = class PermissionModuleService {
    ...
    create(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.permissionModuleRepository.repository.save(data);
        });
    }
    // find one permission module
    findOne(data) {
        return this.permissionModuleRepository.repository.findOne(data);
    }
    ...
    findAll(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.permissionModuleRepository.repository.find(data);
        });
    }
    ...
    list(limit, offset, select = [], search = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.permissionModuleRepository.repository.count(condition);
        }
        else {
            return this.permissionModuleRepository.repository.find(condition);
        }
    }
    // delete page
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.permissionModuleRepository.repository.delete(id);
        });
    }
};
exports.PermissionModuleService = PermissionModuleService;
exports.PermissionModuleService = PermissionModuleService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
