...
let RegistrationOtpService = class RegistrationOtpService {
    ...
    create(userOtp) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newUserOtp = yield this.registrationOtpRepository.repository.save(userOtp);
            return newUserOtp;
        });
    }
    // update userOtp
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.registrationOtpRepository.repository.delete(id);
        });
    }
    // find userOtp
...
exports.RegistrationOtpService = RegistrationOtpService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
