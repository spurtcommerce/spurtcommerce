...
let ZoneService = class ZoneService {
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(Zone_1.Zone).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.zoneRepository.repository.delete(id);
        });
    }
};
exports.ZoneService = ZoneService;
exports.ZoneService = ZoneService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
