...
let VendorDocumentService = class VendorDocumentService {
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(VendorDocument_1.VendorDocument).createQueryBuilder('vendorDocument');
            // Select
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.vendorDocumentRepository.repository.delete(id);
        });
    }
    softDelete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.vendorDocumentRepository.repository.update({ id }, { isDelete: 1 });
        });
    }
};
exports.VendorDocumentService = VendorDocumentService;
exports.VendorDocumentService = VendorDocumentService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
