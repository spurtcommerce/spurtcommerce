...
let SiteFilterService = class SiteFilterService {
    ...
    create(siteFilter) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newSiteFilter = yield this.siteFilterRepository.repository.save(siteFilter);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newSiteFilter = yield this.siteFilterRepository.repository.delete(id);
            return newSiteFilter;
        });
    }
};
exports.SiteFilterService = SiteFilterService;
exports.SiteFilterService = SiteFilterService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
