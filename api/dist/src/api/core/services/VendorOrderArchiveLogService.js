...
let VendorOrderArchiveLogService = class VendorOrderArchiveLogService {
    ...
    create(vendorOrderArchiveLog) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newVendorOrderArchiveLog = yield this.vendorOrderArchiveLogRepository.repository.save(vendorOrderArchiveLog);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteVendorOrderArchiveLog = yield this.vendorOrderArchiveLogRepository.repository.delete(id);
...
exports.VendorOrderArchiveLogService = VendorOrderArchiveLogService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
