...
let DocumentService = class DocumentService {
    constructor(documentRepository, log) {
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(Document_1.Document).createQueryBuilder('document');
            // Select
...
exports.DocumentService = DocumentService = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [DocumentRepository_1.DocumentRepository, Object])
], DocumentService);
