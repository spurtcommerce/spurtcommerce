...
let S3Service = class S3Service {
    ...
    deleteMultipleFile(filePaths) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (filePaths.length > 900) {
                const lengths = Math.ceil(filePaths.length / 900);
                for (let i = 0; i < lengths; i++) {
                    yield this.deleteS3Batch(filePaths.splice(0, 900));
                }
            }
            else {
                yield this.deleteS3Batch(filePaths);
            }
        });
    }
    // Image resize
    ...
    resizeImageBase64(imgName = '', imgPath = '', widthString, heightString) {
        ...
        const getParams = {
            Bucket: env_1.aws_setup.AWS_BUCKET, // your bucket name,
    ...
    fileDownload() {
        return tslib_1.__awaiter(this, arguments, void 0, function* (folderName = '', dataFile) {
    ...
    videoFileDownload() {
        return tslib_1.__awaiter(this, arguments, void 0, function* (folderName = '', dataFile, directoryPath = '') {
            const command = new client_s3_1.GetObjectCommand({
                Bucket: env_1.aws_setup.AWS_BUCKET,
                Key: folderName + dataFile,
            });
