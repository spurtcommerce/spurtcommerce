...
let SettlementService = class SettlementService {
    ...
    create(settlement) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newSettlement = yield this.settlementRepository.repository.save(settlement);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newSettlement = yield this.settlementRepository.repository.delete(id);
            return newSettlement;
        });
    }
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(Settlement_1.Settlement).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
exports.SettlementService = SettlementService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
