...
let VendorOrderArchiveService = class VendorOrderArchiveService {
    ...
    create(vendorOrderArchive) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newVendorOrderArchive = yield this.vendorOrderArchiveRepository.repository.save(vendorOrderArchive);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteVendorOrderArchive = yield this.vendorOrderArchiveRepository.repository.delete(id);
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(VendorOrderArchive_1.VendorOrderArchive).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
exports.VendorOrderArchiveService = VendorOrderArchiveService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
