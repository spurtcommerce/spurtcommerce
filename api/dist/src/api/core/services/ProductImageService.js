...
let ProductImageService = class ProductImageService {
    ...
    // find all product images
    find(condition) {
        return this.productImageRepository.repository.find(condition ? condition : {});
    }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productImageRepository.repository.delete(id);
        });
    }
    // delete product
    deleteProduct(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productImageRepository.repository.delete({ productId: id });
        });
    }
};
exports.ProductImageService = ProductImageService;
exports.ProductImageService = ProductImageService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
