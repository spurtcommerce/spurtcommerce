...
let ProductToCategoryService = class ProductToCategoryService {
    ...
    find(condition) {
        this.log.info('Find all product');
        return this.productToCategoryRepository.repository.find(condition ? condition : {});
    }
    // product list
    ...
    create(product) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.productToCategoryRepository.repository.save(product);
            return newProduct;
        });
    }
    // update product
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newProduct = yield this.productToCategoryRepository.repository.delete(id);
            return newProduct;
        });
    }
};
exports.ProductToCategoryService = ProductToCategoryService;
exports.ProductToCategoryService = ProductToCategoryService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
