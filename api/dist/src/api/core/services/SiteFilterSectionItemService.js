...
let SiteFilterSectionItemService = class SiteFilterSectionItemService {
    ...
    create(siteFilterSectionItem) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newSiteFilterSection = yield this.siteFilterSectionItemRepository.repository.save(siteFilterSectionItem);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newSiteFilter = yield this.siteFilterSectionItemRepository.repository.delete(id);
            return newSiteFilter;
        });
    }
};
exports.SiteFilterSectionItemService = SiteFilterSectionItemService;
exports.SiteFilterSectionItemService = SiteFilterSectionItemService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
