...
let PageGroupTranslationService = class PageGroupTranslationService {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.pageGroupTranslationRepository.repository.delete(id);
        });
    }
};
exports.PageGroupTranslationService = PageGroupTranslationService;
exports.PageGroupTranslationService = PageGroupTranslationService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
