...
let ProductService = class ProductService {
    ...
    findOne(findCondition) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productRepository.repository.findOne(findCondition);
        });
    }
    // product list
    ...
    create(product) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.productRepository.repository.save(product);
            return newProduct;
        });
    }
    // Bulk Create
    bulkCreate(productData) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProducts = yield this.productRepository.repository.save(productData);
            return newProducts;
        });
    }
    // update product
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newProduct = yield this.productRepository.repository.delete(id);
            return newProduct;
        });
    }
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            ...
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(ProductModel_1.Product).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
