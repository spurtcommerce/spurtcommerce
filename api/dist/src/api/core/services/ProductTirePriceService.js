...
let ProductTirePriceService = class ProductTirePriceService {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteProductTireValue = yield this.productTirePriceRepository.repository.delete(id);
...
exports.ProductTirePriceService = ProductTirePriceService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
