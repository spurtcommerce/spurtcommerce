...
let ProductDiscountService = class ProductDiscountService {
    ...
    find(condition) {
        this.log.info('Find a data');
        return this.productDiscountRepository.repository.find(condition ? condition : {});
    }
    // delete product option
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.log.info('Delete a product option');
            const deleteProductDiscount = yield this.productDiscountRepository.repository.delete(id);
...
exports.ProductDiscountService = ProductDiscountService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
