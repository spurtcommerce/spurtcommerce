...
let ProductPriceLogService = class ProductPriceLogService {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteProductOptionValue = yield this.productPriceLogRepository.repository.delete(id);
...
exports.ProductPriceLogService = ProductPriceLogService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
