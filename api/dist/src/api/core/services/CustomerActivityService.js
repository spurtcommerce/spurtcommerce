...
let CustomerActivityService = class CustomerActivityService {
    ...
    create(customerActivity) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newCustomerActivity = yield this.customerActivityRepository.repository.save(customerActivity);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteCustomerActivity = yield this.customerActivityRepository.repository.delete(id);
            return deleteCustomerActivity;
        });
    }
};
exports.CustomerActivityService = CustomerActivityService;
exports.CustomerActivityService = CustomerActivityService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
