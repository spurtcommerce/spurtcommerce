...
let UserGroupService = class UserGroupService {
    ...
    create(userGroup) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newUserGroup = yield this.userGroupRepository.repository.save(userGroup);
            return newUserGroup;
        });
    }
    // update role
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteUser = yield this.userGroupRepository.repository.delete(id);
            return deleteUser;
        });
    }
};
exports.UserGroupService = UserGroupService;
exports.UserGroupService = UserGroupService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
