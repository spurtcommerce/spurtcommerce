...
let AuditLogService = class AuditLogService {
    ...
    createOrUpdate(object) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const addedData = yield this.auditLogRepository.repository.save(object);
            return addedData;
        });
    }
    QueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, whereCondition = [], relations = [], search = [], count, order) {
            this.log.info('list');
            const queryConditions = yield this.auditLogRepository.repository.createQueryBuilder('AuditLog');
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(AuditLog_1.AuditLog).createQueryBuilder();
            // Select
    ...
    delete(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.auditLogRepository.repository.delete(data);
            return;
        });
    }
