...
let IndustryService = class IndustryService {
    ...
    listByQueryBuilder(limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield (0, index_1.getConnection)().getRepository(Industry_1.Industry).createQueryBuilder();
            // Select
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.industryRepository.delete(id);
        });
    }
};
IndustryService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
