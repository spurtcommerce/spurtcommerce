...
const IndustryRepository_1 = require("../repositories/IndustryRepository");
const typeormLoader_1 = require("../../../loaders/typeormLoader");
let IndustryService = class IndustryService {
    constructor(industryRepository, log) {
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(Industry_1.Industry).createQueryBuilder();
            // Select
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.industryRepository.repository.delete(id);
        });
    }
};
exports.IndustryService = IndustryService;
exports.IndustryService = IndustryService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
    tslib_1.__param(1, (0, Logger_1.Logger)(__filename)),
    tslib_1.__metadata("design:paramtypes", [IndustryRepository_1.IndustryRepository, Object])
], IndustryService);
