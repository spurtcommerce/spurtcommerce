...
let VendorOrderProductsService = class VendorOrderProductsService {
    ...
    create(vendorOrderProduct) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newvendorOrderProduct = yield this.vendorOrderProductsRepository.repository.save(vendorOrderProduct);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteVendorOrderProducts = yield this.vendorOrderProductsRepository.repository.delete(id);
...
exports.VendorOrderProductsService = VendorOrderProductsService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
