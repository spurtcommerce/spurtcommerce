...
let ProductStockAlertService = class ProductStockAlertService {
    ...
    create(stockAlert) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newStockAlert = yield this.productStockAlertRepository.repository.save(stockAlert);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.productStockAlertRepository.repository.delete(id);
        });
    }
};
exports.ProductStockAlertService = ProductStockAlertService;
exports.ProductStockAlertService = ProductStockAlertService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
