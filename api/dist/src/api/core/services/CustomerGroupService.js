...
let CustomerGroupService = class CustomerGroupService {
    ...
    create(customerGroup) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newCustomerGroup = yield this.customerGroupRepository.repository.save(customerGroup);
            return newCustomerGroup;
        });
    }
    createBulk(customerGroup) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newCustomerGroup = yield this.customerGroupRepository.repository.save(customerGroup);
            return newCustomerGroup;
        });
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteCustomer = yield this.customerGroupRepository.repository.delete(id);
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(CustomerGroup_1.CustomerGroup).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
exports.CustomerGroupService = CustomerGroupService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
