...
let PermissionModuleGroupService = class PermissionModuleGroupService {
    ...
    findAll(data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.permissionModuleGroupRepository.repository.find(data);
        });
    }
    // page List
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.permissionModuleGroupRepository.repository.delete(id);
        });
    }
};
exports.PermissionModuleGroupService = PermissionModuleGroupService;
exports.PermissionModuleGroupService = PermissionModuleGroupService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
