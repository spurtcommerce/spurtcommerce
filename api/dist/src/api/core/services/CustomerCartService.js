...
let CustomerCartService = class CustomerCartService {
    ...
    update(cartId, customerId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.customerCartRepository.repository.update({ id: (0, typeorm_1.In)(cartId) }, { customerId });
        });
    }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newProduct = yield this.customerCartRepository.repository.delete(id);
            return newProduct;
        });
    }
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(CustomerCart_1.CustomerCart).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
exports.CustomerCartService = CustomerCartService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
