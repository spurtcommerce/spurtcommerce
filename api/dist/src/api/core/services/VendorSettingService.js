...
let VendorGlobalSettingService = class VendorGlobalSettingService {
    ...
    // find one page
    findOne(condition) {
        return this.vendorGlobalSettingRepository.repository.findOne(condition ? condition : {});
    }
    // find one page
    findOneData(data) {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.vendorGlobalSettingRepository.repository.delete(id);
        });
    }
};
exports.VendorGlobalSettingService = VendorGlobalSettingService;
exports.VendorGlobalSettingService = VendorGlobalSettingService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
