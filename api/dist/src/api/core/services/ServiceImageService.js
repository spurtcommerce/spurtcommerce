...
let ServiceImageService = class ServiceImageService {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.serviceImageRepository.repository.delete(id);
        });
    }
    // delete service
    deleteProduct(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.serviceImageRepository.repository.delete({ serviceId: id });
        });
    }
};
exports.ServiceImageService = ServiceImageService;
exports.ServiceImageService = ServiceImageService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
