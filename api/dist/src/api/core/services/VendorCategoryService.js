...
let VendorCategoryService = class VendorCategoryService {
    ...
    create(vendorCategory) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newVendorCategory = yield this.vendorCategoryRepository.repository.save(vendorCategory);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteUser = yield this.vendorCategoryRepository.repository.delete(id);
            return deleteUser;
        });
    }
...
exports.VendorCategoryService = VendorCategoryService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
