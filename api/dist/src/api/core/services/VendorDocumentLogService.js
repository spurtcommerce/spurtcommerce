...
let VendorDocumentLogService = class VendorDocumentLogService {
    ...
    create(vendorDocLog) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newVendorDocumentLog = yield this.vendorDocumentLogRepository.repository.save(vendorDocLog);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const newVendorDocumentLog = yield this.vendorDocumentLogRepository.repository.delete(id);
            return newVendorDocumentLog;
        });
    }
    // find vendorDocLog
...
exports.VendorDocumentLogService = VendorDocumentLogService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
