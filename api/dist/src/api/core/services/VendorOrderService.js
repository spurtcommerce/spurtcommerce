...
let VendorOrdersService = class VendorOrdersService {
    ...
    create(vendorOrders) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newVendorCategory = yield this.vendorOrdersRepository.repository.save(vendorOrders);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteVendor = yield this.vendorOrdersRepository.repository.delete(id);
            return deleteVendor;
        });
    }
    // find Services
    ...
    listByQueryBuilder(limit_1, offset_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count, rawQuery = false) {
            const query = yield (0, typeormLoader_1.getDataSource)().getRepository(VendorOrders_1.VendorOrders).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
exports.VendorOrdersService = VendorOrdersService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
