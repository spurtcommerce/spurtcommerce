...
let MediaController = class MediaController {
    ...
    uploadFile(fileNameRequest, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (type === 'application/zip' || type === 'application/x-zip-compressed' || type === '@file/zip') {
                ext = 'zip';
            }
            ...
            if (fileNameRequest.fileType === 2) {
                ...
                docSize = +env_1.env.zipUploadSize * 1024;
                if (fileName) {
                    const originalName = fileName.split('.')[0];
                    name = originalName + '_' + Date.now() + '.zip';
                }
                else {
                    name = 'ZIP_' + Date.now() + '.zip';
                }
            }
    ...
    uploadProductFile(fileNameRequest, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            var _a;
            const base64 = fileNameRequest.image;
            const path = (_a = fileNameRequest.path) !== null && _a !== void 0 ? _a : 'documents/';
...
tslib_1.__decorate([
    (0, routing_controllers_1.Post)('/upload-product-file')
    // @Authorized('admin-vendor')
    ,
    tslib_1.__param(0, (0, routing_controllers_1.Body)({ validate: true })),
    tslib_1.__param(1, (0, routing_controllers_1.Req)()),
    ...
    tslib_1.__metadata("design:paramtypes", [CreateFileNameRequest_1.FileNameRequest, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], MediaController.prototype, "uploadProductFile", null);
tslib_1.__decorate([
