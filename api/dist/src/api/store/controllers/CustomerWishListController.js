...
let StoreCustomerWishListController = class StoreCustomerWishListController {
    constructor(customerWishlistService, productImageService, productService, productTranslationService) {
    ...
    wishlistProductDelete(wishlistId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.customerWishlistService.delete({ wishlistProductId: customerwishlistId.wishlistProductId });
            const successResponse = {
                status: 1,
    ...
    wishlistProductlist(limit, offset, count, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const promises = productList.map((result) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                var _a, _b, _c;
                const temp = result;
                const productTranslation = yield this.productTranslationService.findOne({ where: { productId: result.productId, languageId: (_a = request.languageId) !== null && _a !== void 0 ? _a : 0 } });
                temp.productNameTrans = (_b = productTranslation === null || productTranslation === void 0 ? void 0 : productTranslation.name) !== null && _b !== void 0 ? _b : '';
                temp.productDescriptionTrans = (_c = productTranslation === null || productTranslation === void 0 ? void 0 : productTranslation.description) !== null && _c !== void 0 ? _c : '';
...
exports.StoreCustomerWishListController = StoreCustomerWishListController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
