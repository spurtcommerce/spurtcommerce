...
let GmailController = class GmailController {
    ...
    Login(postParams, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const LoginLogRepository = (0, typeormLoader_1.getDataSource)().getRepository(LoginLog_1.LoginLog);
            ...
            if (!resultData) {
                ...
                const accessTokenRepository = (0, typeormLoader_1.getDataSource)().getRepository(AccessTokenModel_1.AccessToken);
                ...
                const logo = yield SettingRepository.findOne({ where: {} });
                const mailContents = {};
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    Logins(postParams, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const CustomerRepository = (0, typeormLoader_1.getDataSource)().getRepository(Customer_1.Customer);
            const EmailTemplateRepository = (0, typeormLoader_1.getDataSource)().getRepository(EmailTemplate_1.EmailTemplate);
            const LoginLogRepository = (0, typeormLoader_1.getDataSource)().getRepository(LoginLog_1.LoginLog);
...
tslib_1.__decorate([
    (0, routing_controllers_1.Post)('/oauth-register'),
    tslib_1.__param(0, (0, routing_controllers_1.Body)({ validate: true })),
    tslib_1.__param(1, (0, routing_controllers_1.Req)()),
    tslib_1.__param(2, (0, routing_controllers_1.Res)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], GmailController.prototype, "Logins", null);
