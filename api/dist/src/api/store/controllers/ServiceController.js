...
let StoreServiceController = class StoreServiceController {
    ...
    SendEnquiry(enquiryParam, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (enquirySave) {
                const emailContent = yield this.emailTemplateService.findOne({ where: { emailTemplateId: 8 } });
...
exports.StoreServiceController = StoreServiceController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
