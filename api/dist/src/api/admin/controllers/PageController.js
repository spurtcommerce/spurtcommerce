...
let PageController = class PageController {
    ...
    deletePage(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deletePage = yield this.pageService.delete({ pageId: page.pageId });
            if (deletePage) {
                const successResponse = {
                    status: 1,
    ...
    deleteMultiplePage(pageDelete, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of pageid) {
                const dataId = yield this.pageService.findOne({ where: { pageId: id } });
                if (!dataId) {
                    const errorResponse = {
                        status: 0,
                    ...
                    yield this.pageService.delete({ pageId: deletePageId });
                }
            }
            const successResponse = {
                status: 1,
...
exports.PageController = PageController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
