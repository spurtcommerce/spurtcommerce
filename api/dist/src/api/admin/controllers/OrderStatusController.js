...
let OrderStatusController = class OrderStatusController {
    ...
    deleteOrderStatus(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteOrderStatus = yield this.orderStatusService.delete({ orderStatusId: orderStatus.orderStatusId });
...
exports.OrderStatusController = OrderStatusController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
