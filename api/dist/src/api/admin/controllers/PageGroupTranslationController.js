...
let PageGroupTranslationController = class PageGroupTranslationController {
    ...
    createPageGroupTranslation(payload, GroupId, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const getPageGroup = yield this.pageGroupService.findOne({ where: { groupId: GroupId } });
            if (!getPageGroup) {
                const errorResponse = {
                    status: 0,
...
exports.PageGroupTranslationController = PageGroupTranslationController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
