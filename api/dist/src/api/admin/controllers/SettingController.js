...
let SettingController = class SettingController {
    ...
    settingsDetail(settingsId, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const currencyData = yield this.currencyService.findOne({ where: { currencyId: settings.storeCurrencyId } });
            const settingsDetail = Object.assign(Object.assign({ currencyCode: currencyData === null || currencyData === void 0 ? void 0 : currencyData.code, symbolLeft: currencyData === null || currencyData === void 0 ? void 0 : currencyData.symbolLeft, symbolRight: currencyData === null || currencyData === void 0 ? void 0 : currencyData.symbolRight }, settings), { countryIds: settings.country.split(',') });
            const successResponse = {
                status: 1,
                message: 'Successfully get settings',
                data: settingsDetail,
    ...
    createSettings(settings, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            settingValue.accessKey = (_a = settings.accessKey) === null || _a === void 0 ? void 0 : _a.trim();
            ...
            if ((_b = settings.siteCategory) === null || _b === void 0 ? void 0 : _b.trim()) {
    ...
    deleteReason(id, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.orderCancelReasonService.delete({ id: orderCancelReason.id });
            const successResponse = {
                status: 1,
                message: 'Successfully reason deleted.',
...
exports.SettingController = SettingController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
