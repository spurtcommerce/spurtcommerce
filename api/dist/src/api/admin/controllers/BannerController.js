...
let BannerController = class BannerController {
    ...
    deleteBanner(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteBanner = yield this.bannerService.delete({ bannerId: banner.bannerId });
            if (deleteBanner) {
                const successResponse = {
                    status: 1,
                    message: 'Successfully deleted banner',
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of bannerid) {
                ...
                if (!dataId) {
                    ...
                    yield this.bannerService.delete({ bannerId: deleteBannerId });
                }
            }
            const successResponse = {
                status: 1,
    ...
    bannerView(bannerId, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of bannerid) {
                const dataId = yield this.bannerService.findOne({ where: { id } });
...
exports.BannerController = BannerController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
