    ...
    updateServiceCategory(id, updateCategory, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const val of deleteCategory) {
                yield this.serviceCategoryPathService.delete({ categoryPathId: val.categoryPathId });
            }
            const getAllPath = yield this.serviceCategoryPathService.find({
    ...
    deleteCategory(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const path of categoryPath) {
                yield this.serviceCategoryPathService.delete({ categoryPathId: path.categoryPathId });
            }
            const deleteCategory = yield this.serviceCategoryService.delete({ serviceCategoryId: serviceCategoryId.id });
            if (!deleteCategory) {
                const successResponse = {
                    status: 1,
...
exports.ServiceCategoryController = ServiceCategoryController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
