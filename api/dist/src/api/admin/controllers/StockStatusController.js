...
let StockStatusController = class StockStatusController {
    ...
    deleteStockStatus(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteStockStatus = yield this.stockStatusService.delete({ stockStatusId: stockStatus.stockStatusId });
...
exports.StockStatusController = StockStatusController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
