...
let EmailTemplateController = class EmailTemplateController {
    ...
    addEmailTemplate(emailTemplateParam, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const ifCheckTitle = yield this.emailTemplateService.findOne({
                where: {
    ...
    deleteEmailTemplate(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteEmailTemplate = yield this.emailTemplateService.delete({ emailTemplateId: emailTemplate.emailTemplateId });
