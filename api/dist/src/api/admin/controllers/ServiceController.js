...
let ServiceController = class ServiceController {
            ...
            const services = serviceList.map((value) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const categoryValue = yield this.serviceToCategoryService.find({
                    ...
                    const category = val.map((values) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                        const categoryNames = yield this.serviceCategoryService.findOne({ where: { serviceCategoryId: values.serviceCategoryId } });
    ...
    deleteservice(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteService = yield this.serviceService.delete({ serviceId: service.serviceId });
            // delete service category
            yield this.serviceToCategoryService.delete({ serviceId: service.serviceId });
    ...
    deleteMultipleService(deleteService, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const data = service.map((id) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                const dataId = yield this.serviceService.findOne({ where: { serviceId: id } });
                if (!dataId) {
                    const errorResponse = {
                        status: 0,
                        message: 'Invalid Service Id',
                    ...
                    yield this.serviceService.delete({ serviceId: dataId.serviceId });
                    // delete service category
                    yield this.serviceToCategoryService.delete({ serviceId: dataId.serviceId });
                    // Delete service images
    ...
    deleteEnquiry(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteEnquiry = yield this.serviceEnquiryService.delete({ enquiryId: enquiry.enquiryId });
            if (!deleteEnquiry) {
                const successResponse = {
                    status: 1,
    ...
    deleteMultipleEnquiry(deleteEnquires, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const data = enquiry.map((id) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                const dataId = yield this.serviceEnquiryService.findOne({ where: { enquiryId: id } });
                if (!dataId) {
                    const errorResponse = {
                        status: 0,
                        message: 'Invalid Enquiry Id',
                    ...
                    return yield this.serviceEnquiryService.delete({ enquiryId: dataId });
                }
            }));
