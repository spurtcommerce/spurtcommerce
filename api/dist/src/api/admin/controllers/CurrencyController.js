...
let CurrencyController = class CurrencyController {
    constructor(currencyService, settingService) {
    ...
    updateCurrency(currencyParam, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            currency.symbolLeft = (currencyParam.symbolLeft) ? undefined : currencyParam.symbolLeft;
            currency.symbolRight = (currencyParam.symbolRight) ? undefined : currencyParam.symbolRight;
    ...
    deleteCurrency(id, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const adminCurrencyExist = yield this.settingService.findOne({ where: { storeCurrencyId: id } });
            if (adminCurrencyExist) {
                const errorResponse = {
                    status: 0,
                    message: 'This currency cannot be deleted as it is mapped in the admin settings.',
                };
                return response.status(400).send(errorResponse);
            }
            const deleteCurrency = yield this.currencyService.delete({ currencyId: currency.currencyId });
            if (deleteCurrency) {
                const successResponse = {
                    status: 1,
