...
let ImportController = class ImportController {
    constructor(imageService, categoryService, bulkImport, productController, s3Service) {
    ...
    productImport(file, buffer, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.productController.bulkProductImport(xlsxToJson, authorization, request.user.id);
...
tslib_1.__decorate([
    (0, routing_controllers_1.Post)('/get-buffer'),
    tslib_1.__param(0, (0, routing_controllers_1.UploadedFile)('files')),
    tslib_1.__param(1, (0, routing_controllers_1.Res)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], ImportController.prototype, "checking", null);
exports.ImportController = ImportController = tslib_1.__decorate([
    (0, typedi_1.Service)(),
