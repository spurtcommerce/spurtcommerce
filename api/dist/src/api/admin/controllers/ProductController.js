...
let ProductController = class ProductController {
    ...
    getProductList(limit, offset, keyword, sku, status, price, count, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const list = yield (0, product_1.productList)((0, typeormLoader_1.getDataSource)(), [
                'productId',
                'sku',
                'productName',
                'quantity',
    ...
    addProduct(product, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const productNpm = yield (0, product_1.productCreate)(product, (0, typeormLoader_1.getDataSource)());
    ...
    productDetail(id, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const productSku = yield this.skuService.findOne({ where: { id: productDetails.skuId } });
            ...
            productDetails.productSpecialPrice = yield this.productSpecialService.findAll({
                ...
                const special = val.map((value) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const skuNames = yield this.skuService.findOne({ where: { id: value.skuId } });
                    const temp = value;
                    if (skuNames) {
            ...
            productDetails.productDiscountData = yield this.productDiscountService.findAll({
                ...
                const discount = val.map((value) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const discountSkuNames = yield this.skuService.findOne({ where: { id: value.skuId } });
                    const temp = value;
                    if (discountSkuNames) {
            ...
            productDetails.productTirePrices = yield this.productTirePriceService.findAll({
                ...
                const tirePrice = val.map((value) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const tireSkuNames = yield this.skuService.findOne({ where: { id: value.skuId } });
                    const temp = value;
                    if (tireSkuNames) {
    ...
    topPerformingProucts(limit, offset, count, duration, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (topPerformingProducts.length) {
                return response.status(200).send({
                    status: 1,
    ...
    excelProductView(productId, keyword, sku, status, count, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!productId || productId === '') {
                list = yield (0, product_1.productList)((0, typeormLoader_1.getDataSource)(), [
                    'productId',
                    'sku',
                    'productName',
                    'description',
            ...
            const excelFile = yield (0, product_1.excelExportProduct)((0, typeormLoader_1.getDataSource)(), productIds);
            // Add export log
    ...
    ExportAllProducts(request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const special = [];
            const specialPrices = yield this.productSpecialService.find({ where: {} });
            ...
            worksheet2.getCell('F1').border = { top: { style: 'thin' }, left: { style: 'thin' }, bottom: { style: 'thin' }, right: { style: 'thin' } };
            const discount = [];
            const discountPrices = yield this.productDiscountService.find({ where: {} });
            ...
            const productimage = [];
            const images = yield this.productImageService.find({ where: {} });
            ...
            const categories = yield this.productToCategoryService.find({ where: {} });
    ...
    deleteProduct(productid, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteProduct = yield this.productService.delete({ productId: productid });
    ...
    deleteMultipleProduct(productDelete, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of productid) {
                const dataId = yield this.productService.findOne({ where: { productId: id } });
                if (!dataId) {
                    const errorResponse = {
                        status: 0,
            ...
            for (const id of productid) {
                ...
                const product = yield this.productService.findOne({ where: { productId: id } });
                yield this.skuService.delete({ id: product.skuId });
                const pluginExist = yield couponPlugin(deleteProductId, 1);
                if (pluginExist) {
                    yield hooks.runHook('coupon-delete');
                }
                yield this.productService.delete({ productId: deleteProductId });
            }
            const successResponse = {
                status: 1,
                message: 'Successfully deleted the Product',
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const val of product) {
                ...
                if (metaTagTitle) {
                    ...
                    else if (getProductSlug.length > 1) {
                ...
                for (const fileNames of mainFiles) {
                    ...
                    if (fileType === 'xlsx') {
                        if (fileNames === 'productData.xlsx') {
                            ...
                            const createProduct = yield this.bulkProductImport(result, authorization, request.user.id);
    ...
    bulkProductImport(jsonData, authorization, vendorId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const dataSource = (0, typeormLoader_1.getDataSource)();
            ...
            try {
                ...
                for (const categorydata of productRequest) {
                    const categoryIds = [];
                    // for (const data of categorydata.categories) {
                    ...
                    //         const ifCategory = await categoryRepo.findOne({
                    //             where: {
                    //                 name: categoryArr[0],
                    //                 parentInt: 0,
                    //             },
                    ...
                    for (const categoryStr of categories) {
                        ...
                        const categoryArr = categoryStr.split('>').map(v => v.trim());
                        const length = categoryArr.length;
                        if (length === 1) {
                            const categoryRepo = queryRunner.manager.getRepository(CategoryModel_1.Category);
                            const ifCategory = yield categoryRepo.findOne({
                                where: {
                                    name: categoryArr[0],
                                    // parentInt: 0,
                                },
                            ...
                            if (ifCategory) {
                                categoryIds.push({
                                    ...
                                    categoryId: ifCategory.categoryId,
                                });
                            }
                        }
                    }
                ...
                for (const data of categoryProduct) {
                    ...
                    product.taxType = 1;
                    product.taxValue = data.Tax === '' || data.Tax === null || data.Tax === undefined
                        ? 0
                        : Number(data.Tax);
                    ...
                    // saving sku //
                    const newSku = new SkuModel_1.Sku();
                    newSku.skuName = data.SKU.trim();
                    newSku.price = +data.Price;
                    newSku.quantity = data.Quantity ? Math.round(+data.Quantity) : 1;
                    newSku.isActive = 1;
                    const saveSku = yield queryRunner.manager.save(SkuModel_1.Sku, newSku);
                    // ending sku //
                    ...
                    // product.productHighlights = data.productHighlights;
                    // adding category name and product name in keyword field for keyword search
                    const rowsArr = [];
                    if (data.categories.length > 0) {
                        ...
                        for (const categorys of categories) {
                            ...
                            const categoryData = yield queryRunner.manager.findOne(CategoryModel_1.Category, { where: { name: (categoryNames[categoryLength - 1]).trimStart() } });
                    ...
                    product.height = data.Height !== '' && !isNaN(Number(data.Height)) ? Number(data.Height) : undefined;
                    product.width = data.Width !== '' && !isNaN(Number(data.Width)) ? Number(data.Width) : undefined;
                    product.weight = data.Weight !== '' && !isNaN(Number(data.Weight)) ? Number(data.Weight) : undefined;
                    product.length = data.Length !== '' && !isNaN(Number(data.Length)) ? Number(data.Length) : undefined;
                    product.productHighlights = data.productHighlights
                        ? [{ data: `<p>${String(data.Highlights)}</p>` }]
                        : [];
                    /* eslint-enable no-null-keyword */
                    const savedProduct = yield queryRunner.manager.save(ProductModel_1.Product, product);
                    if (vendorId) {
                        const vendor = yield queryRunner.manager.findOne(Vendor_1.Vendor, {
                            where: {
                                vendorId,
                            },
                        });
                        if (vendor) {
                            ...
                            yield queryRunner.manager.save(VendorProducts_1.VendorProducts, vendorProduct);
                        }
                    }
                    if (data.Images) {
                        ...
                        for (const img of images) {
                            ...
                            productImage.defaultImage = isFirstImage ? 1 : 0;
                            isFirstImage = false;
                            yield queryRunner.manager
                                .getRepository(ProductImage_1.ProductImage)
                                .save(productImage);
                        }
                    }
                    ...
                    //                 let imageExt = 'jpg';
                    //                 if (contentType) {
                    //                     const match = contentType.match(/\/(jpeg|jpg|png)/i);
                    //                     if (match) {
                    //                         imageExt = match[1].toLowerCase() === 'jpeg' ? 'jpg' : match[1].toLowerCase();
                    //                     }
                    //                 }
                    //                 const imageName = `product-${Date.now()}-${Math.floor(Math.random() * 1000)}.${imageExt}`;
                    //                 if (env.imageserver === 's3') {
                    //                     await this.s3Service.imageUpload((imageName), imageBuffer, imageExt);
                    //                 } else {
                    //                     await this.imageService.imageUpload((imageName), imageBuffer);
                    //                 }
                    ...
                    //         const productImages = await queryRunner.manager.find(ProductImage, {
                    //             where: { productId: savedProduct.productId },
                    //         });
                    //         if (productImages.length > 0) {
                    //             productImages[0].defaultImage = 1;
                    //             await queryRunner.manager.save(ProductImage, productImages[0]);
                    //         }
                    //     } else {
                    //         const images = data.Images;
                    ...
                    //             await queryRunner.manager.save(ProductImage, productImage);
                    //         }
                    //         const findImage = await queryRunner.manager.findOne(ProductImage, {
                    //             where: { productId: savedProduct.productId },
                    //         });
                    //         findImage.defaultImage = 1;
                    //         await queryRunner.manager.save(ProductImage, findImage);
                    //     }
                    // }
                    if (data.categories.length >= 1) {
                        // for (const category of data.categories) {
                        //     console.log(category,"categotryy")
                        //     console.log(category.category,"123435")
                        //     const categoryNames = category.split('>');
                        //     const categoryLength = categoryNames.length;
                        //     const categoryData = await queryRunner.manager.findOne(Category, { where: { name: (categoryNames[categoryLength - 1]).trimStart() } });
                        ...
                        //     console.log(savedProduct,"savedprd")
                        //     console.log(savedProduct.productId,"prdycuacyayc")
                        //     newProductToCategory.productId = savedProduct.productId;
                        //     newProductToCategory.categoryId = categoryData.categoryId;
                        //     newProductToCategory.isActive = 1;
                        //     await queryRunner.manager.save(ProductToCategory, newProductToCategory);
                        // }
                        for (const categoryStr of data.categories) {
                            const categoryNames = categoryStr.split('>').map(v => v.trim());
                            const lastCategoryName = categoryNames[categoryNames.length - 1];
                            const categoryData = yield queryRunner.manager.findOne(CategoryModel_1.Category, {
                            ...
                            newProductToCategory.categoryId = categoryData.categoryId;
                            newProductToCategory.isActive = 1;
                            yield queryRunner.manager.save(ProductToCategory_1.ProductToCategory, newProductToCategory);
                            const vendor = yield queryRunner.manager.findOne(Vendor_1.Vendor, {
                                where: { vendorId },
                            });
                            if (vendor) {
                                const vendorGroupId = vendor.vendorGroupId;
                                const existingVendorGroupCategory = yield queryRunner.manager.findOne(VendorGroupCategory_1.VendorGroupCategory, {
                                    where: {
                                        vendorGroupId,
                                        categoryId: categoryData.categoryId,
                                    },
                                });
                                if (!existingVendorGroupCategory) {
                                    const vendorGroupCategory = new VendorGroupCategory_1.VendorGroupCategory();
                                    vendorGroupCategory.vendorGroupId = vendorGroupId;
                                    vendorGroupCategory.categoryId = categoryData.categoryId;
                                    vendorGroupCategory.isActive = 1;
                                    yield queryRunner.manager.save(VendorGroupCategory_1.VendorGroupCategory, vendorGroupCategory);
                                }
                            }
                        }
                    }
                    // Create Variant
                    const findProductVariantbuteStatus = yield queryRunner.manager.findOne(Plugin_1.Plugins, {
                        where: { pluginName: 'ProductVariants', pluginStatus: 1 },
                    });
                    yield queryRunner.commitTransaction();
                    if (data.variant &&
                        data.variant.length > 0 &&
                        data.variant[0].variantSku &&
                        findProductVariantbuteStatus) {
                        ...
                        for (const datas of variantData) {
                            ...
                            yield variant.variantProcess(datas, savedProduct.productId);
                        }
                        // update sku quantity
                        let quantity = 0;
                        for (const quadata of variantData) {
                            quantity += ((_a = quadata.variantQuantity) !== null && _a !== void 0 ? _a : 0);
                        }
                        const findSkuValue = yield queryRunner.manager.findOne(SkuModel_1.Sku, {
                            where: { id: savedProduct.skuId },
                        });
                        if (findSkuValue) {
                            findSkuValue.quantity = quantity;
                            yield queryRunner.manager.save(SkuModel_1.Sku, findSkuValue);
                        }
                        savedProduct.isSimplified = 0;
                        yield queryRunner.manager.save(ProductModel_1.Product, savedProduct);
                    }
                    ...
                    if (discountData.length > 0) {
                        for (const discount of discountData) {
                            ...
                            // const skuData = await queryRunner.manager.findOne(Sku, { where: { skuName: discount.sku } });
                            const skuData = yield queryRunner.manager.findOne(SkuModel_1.Sku, {
                                where: { skuName: data.sku },
                            });
                            if (!skuData) {
                                console.warn(`Discount skipped: SKU not found → ${data.sku} (Product: ${savedProduct.productId})`);
                                continue;
                            }
                            ...
                            if (discount.discountPriority !== undefined && discount.discountStartDate !== undefined && discount.discountEndDate !== undefined) {
                                yield queryRunner.manager.save(ProductDiscount_1.ProductDiscount, newdiscountData);
                            }
                        }
                    }
                    // Product Special
                    if (data.productSpecialPrice.length > 0) {
                        ...
                        for (const special of productSpecials) {
                            const specialPriceData = new ProductSpecial_1.ProductSpecial();
                            // const skuData = await queryRunner.manager.findOne(Sku, { where: { skuName: special.sku } });
                            const skuData = yield queryRunner.manager.findOne(SkuModel_1.Sku, {
                                where: { skuName: data.sku },
                            });
                            if (!skuData) {
                                console.warn(`Special price skipped: SKU not found → ${data.sku} (Product: ${savedProduct.productId})`);
                                continue;
                            }
                            ...
                            if (special.priority !== undefined && special.price !== undefined && special.startDate !== undefined && special.startDate !== undefined && special.endDate !== undefined) {
                                yield queryRunner.manager.save(ProductSpecial_1.ProductSpecial, specialPriceData);
                            }
                        }
                    }
                    // Product tire price
                    if (data.productTirePrice.length > 0) {
                        ...
                        for (const tire of tirePrice) {
                            // normalize SKU
                            const skuName = data.sku;
                            const skuData = yield this.skuService.findOne({
                                where: { skuName }, // or use LOWER() if needed
                            });
                            if (!skuData) {
                                console.warn(`SKU not found for tire price: "${skuName}"`);
                                continue; // skip this tire price instead of crashing
                            }
                            const productTirePrice = new ProductTirePrice_1.ProductTirePrice();
                            ...
                            if (tire.quantity !== undefined && tire.price !== undefined) {
                                yield queryRunner.manager.save(ProductTirePrice_1.ProductTirePrice, productTirePrice);
                            }
                        }
                    }
                    // product video
                    if (data.video.length > 0) {
                        for (const videoData of data.video) {
                            ...
                            productVideo.type = 2;
                            yield queryRunner.manager.save(ProductVideo_1.ProductVideo, productVideo);
                        }
                    }
                    ...
                    const relatedProductsId = (_b = data === null || data === void 0 ? void 0 : data.RelatedProductId) === null || _b === void 0 ? void 0 : _b.split(',');
                    const findProductRelated = yield queryRunner.manager.findOne(Plugin_1.Plugins, { where: { pluginName: 'ProductRelated', pluginStatus: 1 } });
                    if ((relatedProductsId === null || relatedProductsId === void 0 ? void 0 : relatedProductsId.length) > 0 && pluginLoader_1.pluginModule.includes('ProductRelated') && findProductRelated && relatedProductsId[0] !== '') {
                        ...
                        yield axios.post(env_1.env.baseUrl + '/vendor-related-product/update-vendor-related-product', relatedProductObject, { headers });
                    }
                    // Create product Seo
                    const findSeo = yield queryRunner.manager.findOne(Plugin_1.Plugins, { where: { pluginName: 'Seo', pluginStatus: 1 } });
                    if ((data === null || data === void 0 ? void 0 : data.MetaTagTitle) && (data === null || data === void 0 ? void 0 : data.MetaTagDescription) && (data === null || data === void 0 ? void 0 : data.MetaTagKeyword) && (data === null || data === void 0 ? void 0 : data.MetaTagTitle) !== '' && (data === null || data === void 0 ? void 0 : data.MetaTagDescription) !== '' && (data === null || data === void 0 ? void 0 : data.MetaTagKeyword) !== '') {
                        if (pluginLoader_1.pluginModule.includes('Seo') && findSeo) {
                            ...
                            axios.post(env_1.env.baseUrl + '/vendor-product-seo/' + savedProduct.productId, seoObject, { headers });
                        }
                    }
                }
                yield queryRunner.commitTransaction();
                ...
                console.error('Error in bulkProductImport:', error);
    ...
    inventoryProductList(limit, offset, keyword, sku, status, price, count, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const select = ['productId', 'sku', 'name', 'quantity', 'price', 'productSlug', 'isActive', 'hasStock', 'hasTirePrice', 'outOfStockThreshold', 'notifyMinQuantity', 'minQuantityAllowedCart', 'maxQuantityAllowedCart', 'maxQuantityAllowedCart', 'enableBackOrders', 'modifiedDate', 'isSimplified', 'isSpecification', 'skuId'];
            const relation = [];
            const WhereConditions = [
                {
                    name: 'name',
