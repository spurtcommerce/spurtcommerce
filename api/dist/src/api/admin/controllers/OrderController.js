...
let OrderController = class OrderController {
    ...
    orderExportPdf(orderid, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            orderData.zoneData = (zoneData) ? zoneData : ' ';
            orderData.countryData = (countryData) ? countryData : ' ';
    ...
    orderChangeStatus(orderChangeStatus, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const updateOrder = yield this.orderService.findOrder({ where: { orderId: orderChangeStatus.orderId } });
            if (!updateOrder) {
                const errorResponse = {
                    status: 0,
                    message: 'Invalid order Id',
            ...
            const orderLog = yield this.orderLogService.findOne({ where: { orderId: order.orderLogId } });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!orderId || orderId === '') {
                ...
                for (const id of orderid) {
                    const dataId = yield this.orderService.findOrder({ where: { orderId: id } });
    ...
    deleteMultipleOrder(orderDelete, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of orderid) {
                ...
                yield this.orderService.delete({ orderId: deleteOrderId });
            }
            const successResponse = {
                status: 1,
                message: 'Order deleted successfully',
    ...
    updateOrderProductShippingInformation(orderProductId, trackingUrl, trackingNo, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const updateOrderProduct = yield this.orderProductService.findOne({ where: { orderProductId } });
    ...
    updateOrderProductStatus(orderProductId, orderStatusId, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (orderProductStatusUpdate) {
                ...
                const orderStatus = yield this.orderStatusService.findOne({ where: { orderStatusId } });
    ...
    updationForMainOrder(paymentParam, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const updateOrder = yield this.orderService.findOrder({ where: { orderId: paymentParam.orderId } });
            if (!updateOrder) {
                const errorResponse = {
                    status: 0,
                    message: 'Invalid order Id',
