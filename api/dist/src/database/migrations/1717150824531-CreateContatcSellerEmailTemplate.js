...
exports.CreateContatcSellerEmailTemplate1717150824531 = void 0;
const tslib_1 = require("tslib");
const EmailTemplate_1 = require("../../api/core/models/EmailTemplate");
class CreateContatcSellerEmailTemplate1717150824531 {
    up(queryRunner) {
        ...
        <table width=" 100%" cellpadding="0" cellspacing="0"
            ...
            const exist = yield queryRunner.query('SELECT * FROM `email_template` WHERE `id` = ' + '"44"');
            if (exist.length === 0) {
                ...
                yield Repo.save(QuestionAndAnswerEmailSeed);
            }
        });
    }
    down(queryRunner) {
...
exports.CreateContatcSellerEmailTemplate1717150824531 = CreateContatcSellerEmailTemplate1717150824531;
//# sourceMappingURL=1717150824531-CreateContatcSellerEmailTemplate.js.map