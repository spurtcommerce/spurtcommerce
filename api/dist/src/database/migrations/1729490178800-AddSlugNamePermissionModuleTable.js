...
class AddSlugNamePermissionModuleTable1729490178800 {
    up(queryRunner) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const repo = queryRunner.manager.getRepository(PermissionModule_1.PermissionModule);
            const ifExistBackOrderList = yield repo.findOne({
            ...
            const ifExistFailedOrderList = yield repo.findOne({
