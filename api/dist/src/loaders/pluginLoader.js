...
const pluginLoader = (settings) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const pluginManager = (0, typeormLoader_1.getDataSource)().getRepository(Plugin_1.Plugins);
    const migrations = (0, typeormLoader_1.getDataSource)().getRepository(Migrations_1.Migrations);
