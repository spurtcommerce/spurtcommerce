...
let AuthService = class AuthService {
    ...
    validateUser(userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.userRepository.repository.findOne({
                where: {
    ...
    validateCustomer(userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const customer = yield this.customerRepository.repository.findOne({
                where: {
    ...
    validateVendor(userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const vendors = yield this.vendorRepository.repository.findOne({
                where: {
                    vendorId: userId,
                }, relations: ['customer'],
            });
    ...
    checkTokenExist(req) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (authorization && authorization.split(' ')[0] === 'Bearer') {
                ...
                const originalEncryptedString = bytes.toString(Crypto.enc.Utf8);
                const checkTokenRevoke = yield this.accessTokenRepository.repository.findOne({
                    where: {
    ...
    validateUserGroup(userGroupId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const group = yield this.userGroupRepository.repository.findOne({
                where: {
                    groupId: userGroupId,
                },
            });
