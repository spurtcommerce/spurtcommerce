...
const startVendorOrderAutoCancelJob = () => {
    ...
    node_cron_1.default.schedule('0 * * * *', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const adminSettingsRepo = (0, typeormLoader_1.getDataSource)().getRepository(Setting_1.Settings);
        const orderProductCancelLog = (0, typeormLoader_1.getDataSource)().getRepository(OrderProductCancelLog_1.OrderProductCancelLog);
        const orderProduct = (0, typeormLoader_1.getDataSource)().getRepository(OrderProduct_1.OrderProduct);
        const orderStatus = (0, typeormLoader_1.getDataSource)().getRepository(OrderStatus_1.OrderStatus);
        const sku = (0, typeormLoader_1.getDataSource)().getRepository(SkuModel_1.Sku);
        ...
        if (!(adminSettingsData === null || adminSettingsData === void 0 ? void 0 : adminSettingsData.isAutoApproveCancellation)) {
            ...
            const startDateJS = moment_1.default.utc().subtract(timeframeValue, timeframeUnit.toLowerCase()).toDate().toString();
